...
Geographies.propTypes = {
  ...
  stateBoundary: PropTypes.oneOfType([PropTypes.bool]),
...
const nameList = [
  ...
  "Cases & Deaths in the U.S. Over Time",
  "50% of Cases Comes From These States",
  "COVID-19 by U.S. Demographics",
  "COVID-19 Across U.S. Communities",
  "COVID-19 by Community Vulnerability Index",
  "COVID-19 by Percent in Poverty",
  "COVID-19 by Metropolitan Status",
  "COVID-19 by Region",
  "COVID-19 by Percent African American",
  "COVID-19 by Residential Segregation Index",
  "COVID-19 by Underlying Comorbidity",
  "COVID-19 by Percent COPD",
  "COVID-19 by Percent CKD",
  "COVID-19 by Percent Diabetes",
  "COVID-19 by Percent Heart Disease",
  "Obesity",
            ...
            <div style={{ width: 312, overflow: "auto", overflowX: "hidden" }}>
              ...
              >
                <div style={{ height: "130%", width: 330 }}>
                  <Menu size="small" compact pointing secondary vertical>
                    <Menu.Item
                      as="a"
                      href="#"
                      name={nameList[0]}
                      active={
                        props.activeCharacter == nameList[0] ||
                        activeItem === nameList[0]
                      }
                      onClick={(e, { name }) => {
                        setsTate({ activeItem: name });
                      }}
                    >
                      <Header as="h4">{nameList[0]}</Header>
                    </Menu.Item>
                    ...
                    <Menu.Item
                      ...
                      name={nameList[16]}
                      active={
                        props.activeCharacter == nameList[16] ||
                        activeItem === nameList[16]
                      }
                      onClick={(e, { name }) => {
                        setsTate({ activeItem: name });
                      }}
                    >
                      <Header as="h5"> COVID-19 Vaccination Tracker </Header>
                    </Menu.Item>
                    ...
                    <Menu.Item
                      ...
                      name={nameList[18]}
                      active={
                        props.activeCharacter == nameList[18] ||
                        activeItem === nameList[18]
                      }
                      onClick={(e, { name }) => {
                        setsTate({ activeItem: name });
                      }}
                    >
                      <Header as="h4">{nameList[18]}</Header>
                    </Menu.Item>
                    ...
                    <Menu.Item
                      ...
                      name={nameList[1]}
                      active={
                        props.activeCharacter == nameList[1] ||
                        activeItem === nameList[1]
                      }
                      onClick={(e, { name }) => {
                        setsTate({ activeItem: name });
                      }}
                    >
                      <Header as="h4">{nameList[1]}</Header>
                    </Menu.Item>
                    ...
                    <Menu.Item
                      ...
                      name={nameList[2]}
                      active={
                        props.activeCharacter == nameList[2] ||
                        activeItem === nameList[2]
                      }
                      onClick={(e, { name }) => {
                        setsTate({ activeItem: name });
                      }}
                    >
                      <Header as="h4">{nameList[2]}</Header>
                    </Menu.Item>
                    ...
                    <Menu.Item
                      ...
                      name={nameList[19]}
                      active={
                        props.activeCharacter == nameList[19] ||
                        activeItem === nameList[19]
                      }
                      onClick={(e, { name }) => {
                        setsTate({ activeItem: name });
                      }}
                    ...
                    <Menu.Item
                      ...
                      name={nameList[20]}
                      active={
                        props.activeCharacter == nameList[20] ||
                        activeItem === nameList[20]
                      }
                      onClick={(e, { name }) => {
                        setsTate({ activeItem: name });
                      }}
                    ...
                    <Menu.Item
                      ...
                      name={nameList[21]}
                      active={
                        props.activeCharacter == nameList[21] ||
                        activeItem === nameList[21]
                      }
                      onClick={(e, { name }) => {
                        setsTate({ activeItem: name });
                      }}
                    ...
                    <Menu.Item
                      ...
                      name={nameList[22]}
                      active={
                        props.activeCharacter == nameList[22] ||
                        activeItem === nameList[22]
                      }
                      onClick={(e, { name }) => {
                        setsTate({ activeItem: name });
                      }}
                    ...
                    <Menu.Item
                      ...
                      name={nameList[8]}
                      active={
                        props.activeCharacter == nameList[8] ||
                        activeItem === nameList[8]
                      }
                      onClick={(e, { name }) => {
                        setsTate({ activeItem: name });
                      }}
                    ...
                    <Menu.Item
                      ...
                      name={nameList[9]}
                      active={
                        props.activeCharacter == nameList[9] ||
                        activeItem === nameList[9]
                      }
                      onClick={(e, { name }) => {
                        setsTate({ activeItem: name });
                      }}
    ...
    <Grid.Row style={{ paddingLeft: 20, paddingBottom: "0rem" }}>
      <Header
        ...
        style={{
          paddingTop: 30,
          paddingLeft: 60,
          color: mortalityColor[1],
          textAlign: "center",
          fontSize: "22pt",
        }}
      >
        <Header.Content>
          How have {activeItem === "Cases" ? "cases" : "deaths"} in the U.S.
          changed over time?
        </Header.Content>
      </Header>
      <Grid.Row style={{ paddingTop: "1rem", paddingLeft: "25rem" }}>
        ...
        >
          ...
          <Menu.Item
            name="Deaths"
            active={activeItem === "Deaths"}
            onClick={() => {
              setActiveItem("Deaths");
              setChartNo2(2);
              setChartNo1(1.5);
              setDisabled(true);
            }}
      ...
      >
        ...
        >
          Average Daily COVID-19 {activeItem === "Cases" ? "Cases" : "Deaths"}{" "}
          {headerTime}
        </Header.Content>
      </Grid.Row>
                    ...
                    content: (
                      ...
                      >
                        <Header.Content style={{ fontSize: "14pt" }}>
                          ...
                          >
                            This figure shows the trend of daily COVID-19 cases
                            in the U.S.. The bar height reflects the number of
                            new cases per day and the line depicts the 7-day
                            moving average of daily cases in the U.S.. There
                            were {numberWithCommas(dailyCases)} new COVID-19
                            cases reported on{" "}
                            {monthNames[
                              new Date(
                                data[data.length - 1].t * 1000
                              ).getMonth()
                            ] +
                              " " +
                              new Date(
                            ...
                            , with an average of{" "}
                            {numberWithCommas(mean7dayCases)} new cases per day
                            reported over the past 7 days. We see a{" "}
                            {percentChangeCases.includes("-")
                              ? "decrease of approximately " +
                                percentChangeCases.substring(1)
                              : "increase of approximately " +
                                percentChangeCases}{" "}
                            in the average new cases over the past 14-day
                            period.
                            <br />
                            <br />
                            *14-day period includes{" "}
                            {monthNames[
                              new Date(
                                data[data.length - 15].t * 1000
                              ).getMonth()
                            ] +
                              " " +
                              new Date(
                    ...
                    content: (
                      ...
                      >
                        <Header.Content style={{ fontSize: "19px" }}>
                          ...
                          >
                            This figure shows the trend of daily COVID-19 deaths
                            in the U.S.. The bar height reflects the number of
                            new deaths per day and the line depicts the 7-day
                            moving average of daily deaths in the U.S.. There
                            were {dailyDeaths} new deaths associated with
                            COVID-19 reported on{" "}
                            {monthNames[
                              new Date(
                                data[data.length - 1].t * 1000
                              ).getMonth()
                            ...
                            , with an average of {mortalityMean} new deaths per
                            day reported over the past 7 days. We see{" "}
                            {percentChangeMortality.includes("-")
                              ? "a decrease of approximately " +
                                percentChangeMortality.substring(1)
                              : "an increase of approximately " +
                                percentChangeMortality}{" "}
                            in average new deaths over the past 14-day period.
                            <br />
                            <br />
                            *14-day period includes{" "}
                            {monthNames[
    ...
    >
      <Grid.Column width={12}>
        ...
        >
          ...
          >
            {data.map((entry, index) => (
              <Cell
                id={index}
                key={`cell-${index}`}
                fill={highlightIndex.indexOf(index) > 0 ? "red" : barColor}
              />
            ))}
          ...
          />
          <Tooltip
            labelFormatter={tooltiptickFormatter}
            formatter={(value) => numberWithCommas(value.toFixed(0))}
      ...
      <Grid.Column width={3} style={{ paddingLeft: "3rem" }}>
        ...
        >
          {" "}
          Jan. 21, 2020: <br /> 1st case in the U.S. confirmed in Washington
        </Message>
        ...
        >
          ...
          <text zIndex={10}>
            Apr. 10, 2020: <br /> First wave peaked at 31,709 new cases <br />
            (7-day avg.){" "}
          </text>
        </Message>
        ...
        >
          ...
          <text zIndex={10}>
            July. 19, 2020: <br /> Second wave peaked at 66,692 new cases <br />
            (7-day avg.){" "}
          </text>
        </Message>
        ...
        >
          ...
          <text zIndex={10}>
            Jan. 8, 2021: <br /> Third wave peaked at 259,616 new cases <br />
            (7-day avg.){" "}
          </text>
        </Message>
      </Grid.Column>
...
function CaseChartAll(props) {
  ...
  const renderCustomizedLabel = (props) => {
    ...
    if (value === 1586491200 && highlightIndex.length >= 2) {
      // 1
      return (
        <g transform="translate(0, -10)">
          <circle
    ...
    } else if (value === 1595131200 && highlightIndex.length >= 3) {
      // 2
      return (
        <g transform="translate(0, -20)">
          <circle
    ...
    } else if (value === 1610082000 && highlightIndex.length >= 4) {
      // 3
      return (
        <g transform="translate(0, -10)">
          <circle
        ...
        >
          ...
          <Bar
            ...
            onAnimationEnd={() => {
              ...
              setTimeout(
                () =>
                  setHighlightIndex((highlightIndex) => [...highlightIndex, 9]),
                wait + 1000
              );
      ...
      <Grid.Column width={3} style={{ paddingLeft: "3rem" }}>
        ...
        <Transition visible={visible4} animation="scale" duration={200}>
          ...
          >
            ...
            <text zindex={10}>
              July. 19, 2020: <br /> Second wave peaked at 66,692 new cases{" "}
              <br />
              (7-day avg.){" "}
            </text>
          </Message>
...
function CaseChart90(props) {
  ...
  return (
    <Grid
      style={{ paddingTop: "1em", paddingLeft: 10, width: 930, height: 450 }}
    >
      <ComposedChart
        width={850}
        height={420}
      ...
      <Transition visible={visible1} animation="scale" duration={200}>
        ...
        >
          {" "}
          Cumulative Confirmed New{" "}
          {barName === "dailyCases" ? "Cases" : "Deaths"} in Past 90 Days:{" "}
...
function CaseChart14(props) {
  ...
  return (
    <Grid
      style={{ paddingTop: "1rem", paddingLeft: 10, width: 930, height: 450 }}
    >
      <ComposedChart
        width={850}
        height={420}
      ...
      >
        ...
        <XAxis
          dataKey="t"
          type="number"
          domain={[data[data.length - 14].t, "dataMax"]}
        ...
        />
        <Tooltip
          labelFormatter={tooltickFormatter}
          formatter={(value) => numberWithCommas(value.toFixed(0))}
          wrapperStyle={{ zIndex: 10 }}
        />
        {/* <Brush dataKey='t'/> */}
      ...
      <Transition visible={visible1} animation="scale" duration={300}>
        ...
        >
          {" "}
          Cumulative Confirmed New{" "}
          {barName === "dailyCases" ? "Cases" : "Deaths"} in Past 14 Days:{" "}
          {numberWithCommas(totalCase)}
        </Message>
      </Transition>
    </Grid>
...
function DeathChartAll(props) {
  ...
  const renderCustomizedLabel = (props) => {
    ...
    if (value === 1590552000 && highlightIndex.length >= 2) {
      // 1
      return (
        <g transform="translate(0, -10)">
          <circle
    ...
    } else if (value === 1600747200 && highlightIndex.length >= 3) {
      // 2
      return (
        <g transform="translate(0, -20)">
          <circle
    ...
    >
      ...
      <Grid.Column width={3} style={{ paddingLeft: "3rem" }}>
        <Transition visible={visible1} animation="scale" duration={300}>
          ...
          >
            {" "}
            Feb. 6, 2020: <br /> First death in US{" "}
          </Message>
        </Transition>
        <Transition visible={visible2} animation="scale" duration={300}>
          ...
          >
            ...
            <text zindex={10}>
              May. 27, 2020: <br /> Coronavirus deaths in the U.S. passed 100K{" "}
            </text>
          </Message>
        </Transition>
        <Transition visible={visible3} animation="scale" duration={300}>
          ...
          >
            ...
            <text zindex={10}>
              Sep. 22, 2020: <br /> Coronavirus deaths in the U.S. passed 200K{" "}
            </text>
          </Message>
        </Transition>
      </Grid.Column>
...
const renderCustomizedLabelCases = ({
  cx,
  cy,
  midAngle,
  innerRadius,
...
const renderCustomizedLabelPop = ({
  cx,
  cy,
  midAngle,
  innerRadius,
  ...
  componentDidMount() {
    fetch("/data/nationalDemogdata.json")
      ...
      .then((data) =>
        this.setState({
          dataTot: [
            data["race"][0]["Hispanic"][0],
            data["race"][0]["Asian"][0],
            data["race"][0]["American Native"][0],
            data["race"][0]["African American"][0],
            data["race"][0]["White"][0],
          ],
        })
      );
    ...
    return (
      <PieChart width={300} height={280}>
        <Pie
          ...
          label={
            this.props.pop == true
              ? renderCustomizedLabelPop
              : renderCustomizedLabelCases
          }
          rate={this.props.pop}
        >
          {dataTot.map((entry, index) => (
            <Cell
              key={`cell-${index}`}
              fill={COLORRace[index % COLORRace.length]}
            />
          ))}
          <Label
            value={this.props.pop == true ? "% of Population" : "% of Cases"}
            position="center"
          />
        </Pie>
      </PieChart>
  ...
  <div ref={ref} style={{ width: 550 }}>
    <Grid.Column rows={2}>
        ...
        <Grid.Column style={{ width: 550, paddingLeft: 0 }}>
          <div>
            <svg width="550" height="80">
              ...
              />
              <text x={110} y={35} style={{ fontSize: "16px" }}>
                {" "}
                White{" "}
              </text>
              ...
              />
              <text x={285} y={35} style={{ fontSize: "16px" }}>
                {" "}
                African Americans{" "}
              </text>
              ...
              <rect
                ...
                style={{
                  fill: pieChartRace[2],
                  strokeWidth: 1,
                  stroke: pieChartRace[2],
                }}
              />
              <text x={460} y={35} style={{ fontSize: "16px" }}>
                {" "}
                Hispanic{" "}
              </text>
              ...
              <rect
                ...
                style={{
                  fill: pieChartRace[3],
                  strokeWidth: 1,
                  stroke: pieChartRace[3],
                }}
              />
              <text x={197.6} y={70} style={{ fontSize: "16px" }}>
                {" "}
                Asian{" "}
              </text>
              ...
              <rect
                ...
                style={{
                  fill: pieChartRace[4],
                  strokeWidth: 1,
                  stroke: pieChartRace[4],
                }}
              />
              <text x={372.5} y={70} style={{ fontSize: "16px" }}>
                {" "}
                American Native{" "}
              </text>
      ...
      <Grid>
        <Grid.Row columns={2}>
          {/* style = {{width: 550}} */}
          <Grid.Column>{/* <Race pop = {false} /> */}</Grid.Column>
          <Grid.Column>
            {/* <Race pop = {true}/>  */}
            {/* style = {{width: 200}} */}
          </Grid.Column>
            ...
            <Table.Header>
              ...
              >
                ...
                >
                  ...
                  {props.fips === "_nation"
                    ? "Select State"
                    : props.abbrev[props.fips]["state_abbr"]}
                </td>
                <td
                  colSpan="1"
                  style={{
              ...
              <Table.Row textAlign="center" style={{ height: 40 }}>
                ...
                <Table.HeaderCell style={{ fontSize: "14px" }}>
                  ...
                  {props.fips === "_nation"
                    ? ""
                    : numberWithCommas(
                        props.data[props.fips]["AdministeredPartial"]
                      )}{" "}
                </Table.HeaderCell>
                <Table.HeaderCell style={{ fontSize: "14px" }}>
                  {" "}
                  {numberWithCommas(
                    props.data["_nation"]["AdministeredPartial"]
                  )}{" "}
                </Table.HeaderCell>
              </Table.Row>
              <Table.Row textAlign="center">
                ...
                <Table.HeaderCell style={{ fontSize: "14px" }}>
                  ...
                  {props.fips === "_nation"
                    ? ""
                    : numberWithCommas(
                        props.data[props.fips]["PercentAdministeredPartial"]
                      ) + "%"}{" "}
                </Table.HeaderCell>
                <Table.HeaderCell style={{ fontSize: "14px" }}>
                  {" "}
                  {numberWithCommas(
                    props.data["_nation"]["PercentAdministeredPartial"]
                  ) + "%"}{" "}
                </Table.HeaderCell>
              </Table.Row>
              <Table.Row textAlign="center">
                ...
                <Table.HeaderCell style={{ fontSize: "14px" }}>
                  ...
                  {props.fips === "_nation"
                    ? ""
                    : numberWithCommas(
                        props.data[props.fips]["Series_Complete_Yes"]
                      )}{" "}
                </Table.HeaderCell>
                <Table.HeaderCell style={{ fontSize: "14px" }}>
                  {" "}
                  {numberWithCommas(
                    props.data["_nation"]["Series_Complete_Yes"]
                  )}{" "}
                </Table.HeaderCell>
              </Table.Row>
              <Table.Row textAlign="center">
                ...
                <Table.HeaderCell style={{ fontSize: "14px" }}>
                  ...
                  {props.fips === "_nation"
                    ? ""
                    : numberWithCommas(
                        props.data[props.fips]["Series_Complete_Pop_Pct"]
                      ) + "%"}{" "}
                </Table.HeaderCell>
                <Table.HeaderCell style={{ fontSize: "14px" }}>
                  {" "}
                  {numberWithCommas(
                    props.data["_nation"]["Series_Complete_Pop_Pct"]
                  ) + "%"}{" "}
                </Table.HeaderCell>
              </Table.Row>
              ...
              <Table.Row textAlign="center">
                ...
                <Table.HeaderCell style={{ fontSize: "14px" }}>
                  ...
                  {props.fips === "_nation"
                    ? ""
                    : numberWithCommas(
                        props.data[props.fips]["Dist_new"].toFixed(0)
                      )}{" "}
                </Table.HeaderCell>
                <Table.HeaderCell style={{ fontSize: "14px" }}>
                  {" "}
                  {numberWithCommas(
                    props.data["_nation"]["Dist_new"].toFixed(0)
                  )}{" "}
                </Table.HeaderCell>
              </Table.Row>
            </Table.Header>
...
const RaceBarChart = (props) => {
  ...
  const valueAccessor =
    (attribute) =>
    ({ payload }) => {
      return payload[attribute] < 3
        ? null
        : payload[attribute] === undefined
        ? null
        : (payload[attribute] / barRatio).toFixed(1) + "%";
    };
  ...
  const data = [
    {
      ...
      black:
        props.demogData["race"][0]["African American"][0]["percentPop"] *
        barRatio,
      hispanic:
        props.demogData["race"][0]["Hispanic"][0]["percentPop"] * barRatio,
      asian: props.demogData["race"][0]["Asian"][0]["percentPop"] * barRatio,
      space: 0.5,
      american_natives:
        props.demogData["race"][0]["American Native"][0]["percentPop"] *
        barRatio,
    ...
    },
    {
      ...
      white:
        props.fips == "_nation"
          ? props.demogData["race"][0]["White"][0]["percentCases"] * barRatio
      ...
      black:
        props.fips == "_nation"
          ? props.demogData["race"][0]["African American"][0]["percentCases"] *
            barRatio
      ...
      hispanic:
        props.fips == "_nation"
          ? props.demogData["race"][0]["Hispanic"][0]["percentCases"] * barRatio
      ...
      asian:
        props.fips == "_nation"
          ? props.demogData["race"][0]["Asian"][0]["percentCases"] * barRatio
      ...
      american_natives:
        props.fips == "_nation"
          ? props.demogData["race"][0]["American Native"][0]["percentCases"] *
            barRatio
      ...
      NHPI:
        props.fips == "_nation"
          ? props.demogData["race"][0]["NHPI"][0]["percentCases"] * barRatio
  ...
  const CustomTooltip = ({ active, payload, label }) => {
    if (active && payload && payload.length && hoverBar[0] >= 0) {
      ...
      return (
        ...
        >
          <p style={{ color: pieChartRace[hoverBar[0]], marginBottom: 4 }}>
            {" "}
            <b> {hoverBar[2]} </b>{" "}
          </p>
          {/* ${payload[hoverBar[0]]['name']}  */}
          <p className="label" style={{ marginBottom: 3 }}>{`% Population: ${(
            data[0][hoverBar[1]] / barRatio
          ).toFixed(1)}`}</p>
          <p className="label" style={{ marginBottom: 0 }}>{`% Cases : ${(
            data[1][hoverBar[1]] / barRatio
          ).toFixed(1)}`}</p>
        </div>
      );
    }
  ...
  return (
    ...
    >
      ...
      <Bar
        ...
        isAnimationActive={false}
        onMouseEnter={() => {
          setHoverBar([2, "hispanic", "Hispanic"]);
          setActiveIndex(2);
        }}
      ...
      >
        ...
        <LabelList
          valueAccessor={valueAccessor("hispanic")}
          fill="white"
      ...
      <Bar
        ...
        isAnimationActive={false}
        onMouseEnter={() => {
          setHoverBar([1, "black", "African Americans"]);
          setActiveIndex(1);
        }}
        onMouseLeave={() => setActiveIndex(-1)}
      >
        ...
        <LabelList
          valueAccessor={valueAccessor("black")}
          fill="white"
          fontWeight={fontWeight}
          fontSize={labelSize}
        />
      ...
      >
        ...
        <LabelList
          valueAccessor={valueAccessor("asian")}
          fill="white"
          fontWeight={fontWeight}
          fontSize={labelSize}
        />
      ...
      <Bar
        ...
        isAnimationActive={false}
        onMouseEnter={() => {
          setHoverBar([5, "NHPI", "Native Hawaiian/Pacific Islanders"]);
          setActiveIndex(5);
        }}
        onMouseLeave={() => setActiveIndex(-1)}
      >
        ...
        <LabelList
          valueAccessor={valueAccessor("NHPI")}
          position="left"
          fill="black"
        />
      </Bar>
      ...
      <Bar
        ...
        id="an"
        barSize={barSize}
        dataKey="american_natives"
        stackId="a"
        fill={pieChartRace[4]}
        isAnimationActive={false}
        onMouseEnter={() => {
          setHoverBar([4, "american_natives", "American Native"]);
          setActiveIndex(4);
        }}
        onMouseLeave={() => setActiveIndex(-1)}
      >
        ...
        <LabelList
          valueAccessor={valueAccessor("american_natives")}
          position="right"
          fill="black"
        />
      </Bar>
      ...
      >
        ...
        <LabelList
          valueAccessor={valueAccessor("white")}
          fill="white"
          fontWeight={fontWeight}
          fontSize={labelSize}
        />
      ...
      >
        ...
        <LabelList
          valueAccessor={valueAccessor("multiOther")}
          fill="white"
          fontWeight={fontWeight}
          fontSize={labelSize}
        />
...
function TabExampleBasic(props) {
  ...
  const panes = [
    {
      menuItem: "State & Nation Vaccination",
      render: () => (
    ...
    {
      menuItem: "Vaccination by Race & Ethnicity",
      render: () => (
        <Tab.Pane attached={false}>
          <RaceBarChart
...
const SideRaceBarChart = (props) => {
  ...
  const data = [
    {
      name: "Multiple/Other",
      popvalue: props.demogData["race"][0]["Multiple/Other"][0]["percentPop"],
      vaxvalue:
        props.vacc === false
          ? props.demogData["race"][0]["Multiple/Other"][0]["percentCases"]
    ...
    },
    {
      ...
      vaxvalue:
        props.vacc === false
          ? props.demogData["race"][0]["NHPI"][0]["percentCases"]
    ...
    },
    {
      ...
      vaxvalue:
        props.vacc === false
          ? props.demogData["race"][0]["Asian"][0]["percentCases"]
    ...
    },
    {
      ...
      vaxvalue:
        props.vacc === false
          ? props.demogData["race"][0]["Hispanic"][0]["percentCases"]
    ...
    },
    {
      ...
      vaxvalue:
        props.vacc === false
          ? props.demogData["race"][0]["White"][0]["percentCases"]
      ...
      return (
        ...
        >
          ...
          <p className="label" style={{ marginBottom: 3 }}>
            % Population: {payload[0].payload.popvalue.toFixed(1)}
          </p>
          <p className="label" style={{ marginBottom: 0 }}>
            % Cases: {payload[0].payload.vaxvalue.toFixed(1)}
          </p>
        </div>
      );
    }
  ...
  return (
    <Grid style={{ paddingTop: 50 }}>
      ...
      >
        <Header style={{ fontSize: "10pt", paddingLeft: 5 }}>
          {" "}
          <center> {props.vacc ? "% Vaccination" : "% Cases"} </center>{" "}
        </Header>
        <BarChart
          layout="vertical"
        ...
        >
          ...
          <Tooltip
            ...
            cursor={false}
          />
          <Bar dataKey="vaxvalue" isAnimationActive={false}>
            {data.map((entry, index) => (
...
export default function NationalReportPilot(props) {
  ...
  useEffect(() => {
    ...
    fetch("/data/vaccinedate.json")
      .then((res) => res.json())
      .then((x) => {
        setVaccineDate(x.date.substring(5, 7) + "/" + x.date.substring(8, 10));
      });
    fetch("/data/rawdata/variable_mapping_Vaccine.json")
      .then((res) => res.json())
      .then((x) => {
        setVaxVarMap(x);
      });
    fetch("/data/ccvi_vac.json")
      .then((res) => res.json())
      .then((x) => setccvi(x));
    fetch("/data/vac_by_bar.json")
      .then((res) => res.json())
      .then((x) => setVacBar(x));
      ...
      .then((x) => {
          ...
          .domain(
            _.map(
              _.filter(
                ...
                (d) => d["percentVaccinatedDose1"] >= 0 && d.fips.length === 2
              ),
        ...
        _.each(x, (d) => {
          if (d["percentVaccinatedDose1"] >= 0) {
            scaleMap[d["percentVaccinatedDose1"]] = cs(
              d["percentVaccinatedDose1"]
            );
          }
        });
  ...
  useEffect(() => {
    fetch("/data/contristates.json")
      .then((res) => res.json())
      .then((x) => {
        setStates50(x);
      });

    fetch("/data/topten.json")
      .then((res) => res.json())
      .then((x) => {
        setTopTen(x);
      });

    fetch("/data/nationalBarChart.json")
      .then((res) => res.json())
      .then((x) => {
    ...
    fetch("/data/topTenCases.json")
      .then((res) => res.json())
      .then((x) => setDataTopCases(x));

    fetch("/data/topTenMortality.json")
      .then((res) => res.json())
    ...
    fetch("/data/nationalDemogdata.json")
      ...
      .then((x) => {
        ...
        var listW = [];
        var count =
          (x["vaccineRace"][0]["White"][0]["seriesCompletePopPctKnown"] >=
            x["vaccineRace"][0]["White"][0]["percentPop"]) +
          (x["vaccineRace"][0]["Hispanic"][0]["seriesCompletePopPctKnown"] >=
            x["vaccineRace"][0]["Hispanic"][0]["percentPop"]) +
          (x["vaccineRace"][0]["African American"][0][
            "seriesCompletePopPctKnown"
          ] >=
            x["vaccineRace"][0]["African American"][0]["percentPop"]) +
          (x["vaccineRace"][0]["Asian"][0]["seriesCompletePopPctKnown"] >=
            x["vaccineRace"][0]["Asian"][0]["percentPop"]) +
          (x["vaccineRace"][0]["American Native"][0][
            "seriesCompletePopPctKnown"
          ] >=
            x["vaccineRace"][0]["American Native"][0]["percentPop"]) +
          (x["vaccineRace"][0]["NHPI"][0]["seriesCompletePopPctKnown"] >=
        ...
        for (i = 0; i < count - 1; i++) {
          ...
          joinedStr =
            joinedStr.substring(0, indexStr + 1) +
            " " +
            joinedStr.substring(indexStr + 1);
        }
  ...
  useEffect(() => {
    ...
    const fetchTimeSeries = async () => {
      ...
      const promStatic = await CHED_static.find(mainQ, {
        projection: {},
      }).toArray();
      // console.log(promStatic[0].data);

      const testQ = { full_fips: "_nation" };
      const promTs = await CHED_series.find(testQ, {
        projection: {},
      }).toArray();
          ...
          >
            ...
            <Grid>
              ...
              <Grid.Column width={14} style={{ paddingLeft: "3rem" }}>
                ...
                >
                  <Header.Content
                    style={{ fontFamily: "lato", fontSize: "14pt", width: 810 }}
                  >
                    The United States has reported{" "}
                    {numberWithCommas(data["_nation"]["casesfig"])} cases, the
                    highest number of any country in the world. The number of
                    cases and deaths differ substantially across American
                    communities. The COVID-19 U.S. Health Equity Report
                    documents how COVID-19 cases and deaths are changing over
                    time, across geography, and by demographics. The report will
                    be released each week to keep track of how COVID-19 is
                    impacting U.S. communities.
                  </Header.Content>
                </div>
                <div id="tracker" style={{ height: 45 }}>
                  {" "}
                </div>

                <center style={{ paddingLeft: 190 }}>
                ...
                <Grid>
                  <Grid.Row
                    columns={5}
                    style={{ width: 1000, paddingLeft: 205, paddingTop: 40 }}
                  >
                    <Grid.Column
                      style={{
                        width: 200,
                    ...
                    >
                      ...
                      >
                        Total doses <br /> delivered
                      </center>
                    </Grid.Column>

                    <Grid.Column
                      style={{ width: 200, paddingLeft: 50, paddingTop: 8 }}
                    >
                      <center
                        style={{
                          width: 200,
                      ...
                      >
                        Total doses <br /> administered
                      </center>
                    </Grid.Column>
                    <Grid.Column
                      style={{ width: 200, paddingLeft: 100, paddingTop: 8 }}
                    >
                      <center
                        style={{
                          width: 200,
                      ...
                      >
                        Number received <br /> at least one dose
                      </center>
                    </Grid.Column>
                    <Grid.Column
                      style={{ width: 200, paddingLeft: 150, paddingTop: 8 }}
                    >
                      <center
                        style={{
                          width: 200,
                  ...
                  <Grid.Row
                    columns={5}
                    style={{ width: 1000, paddingLeft: 205, paddingTop: 0 }}
                  >
                    <Grid.Column
                      style={{ width: 200, paddingLeft: 0, paddingTop: 0 }}
                    >
                      <div
                        style={{
                          width: 200,
                    ...
                    <Grid.Column
                      style={{ width: 200, paddingLeft: 50, paddingTop: 0 }}
                    >
                      <div
                        style={{
                          width: 200,
                    ...
                    <Grid.Column
                      style={{ width: 200, paddingLeft: 100, paddingTop: 0 }}
                    >
                      <div
                        style={{
                          width: 200,
                      ...
                      >
                        <Header style={{ textAlign: "center" }}>
                          ...
                          <Header.Content style={{ paddingBottom: 5 }}>
                            ...
                            >
                              {numberWithCommas(
                                vaccineData["_nation"]["Administered_Dose1"]
                              )}
                            </p>
                            <br />
                          </Header.Content>
                    ...
                    <Grid.Column
                      style={{ width: 200, paddingLeft: 150, paddingTop: 0 }}
                    >
                      <div
                        style={{
                          width: 200,
                  ...
                  <Grid.Row>
                    <Grid.Column
                      style={{ width: 900, paddingLeft: 205, paddingTop: 18 }}
                    >
                      <div style={{ width: 900 }}>
                        <Header>
                          <div>
                ...
                <div id="vaccrace" style={{ height: 45 }}>
                  {" "}
                </div>
                      ...
                      >
                        <center>
                          ...
                          <p style={{ color: "grey", fontSize: "10pt" }}>
                            % vaccination is among those that are fully
                            vaccinated
                          </p>
                          <p style={{ color: "grey", fontSize: "10pt" }}>
                            {" "}
                            % population is among the total population present
                            in the country
                          </p>
                        </center>
                      </Header.Subheader>
                ...
                <Grid>
                  <Grid.Row
                    columns={2}
                    style={{ width: 1360, paddingLeft: 120 }}
                  >
                    <Grid.Column style={{ width: 1000 }}>
                      <Grid rows={1}>
                        <Grid.Row
                          columns={1}
                          style={{ width: 1000, paddingLeft: 100 }}
                        >
                                ...
                                <li>
                                  ...
                                  nationalDemog["vaccineRace"][0]["White"][0][
                                    ...
                                    ? " White Americans make up " +
                                      ...
                                      "% make up fully vaccinated population."
                                    : ""}{" "}
                                </li>
                              )}
                                ...
                                <li>
                                  ...
                                  nationalDemog["vaccineRace"][0][
                                    ...
                                    ? " Hispanic Americans make up " +
                                      ...
                                      "% make up the fully vaccinated population."
                                    : ""}
                                </li>
                              )}
                        ...
                        content: {
                          content: (
                            <div style={{ fontSize: "19px", paddingLeft: 5 }}>
                              <Grid.Row
                                style={{ paddingTop: 0, paddingBottom: 25 }}
                              >
                                <Header.Content
                                  style={{
                                    fontWeight: 300,
                                ...
                                >
                                  ...
                                  {nationalDemogDate}.
                                  <br />
                                  The demographics of vaccinated adults is
                                  ...
                                  . The U.S. CDC reports distribution of
                                  vaccination across non-Hispanic race
                                  categories. Race & ethnicity was known for{" "}
                                  {nationalDemog["vaccineRace"][0][
                                    "Unknown"
                                  ][0]["seriesCompletePopPctUs"].toFixed(0) +
                                    "%"}{" "}
                                  of fully vaccinated adults.
                                  <br />
                                  The CDC notes that “These demographic data
                                  only represent the geographic areas that
                                  contributed data and might differ by
                                  populations prioritized within each state or
                                  jurisdiction’s vaccination phase. Every
                                  geographic area has a different racial and
                                  ethnic composition, and not all are in the
                                  same vaccination phase.” For comparison
                                  purposes, we show the demographics of the U.S.
                                  population. Note that the demographics of the
                                  total population will include some areas that
                                  are not represented in the vaccination data.
                                  The numbers are therefore our best estimation
                                  of vaccination coverage by race.
                                </Header.Content>
                              </Grid.Row>
                            </div>
                          ),
                ...
                >
                  ...
                  <Grid>
                    <Grid.Row>
                      ...
                      <ChartSection
                        data={dataTS["_nation"]}
                        barColor={mortalityColor[0]}
                        lineColor={[mortalityColor[1]]}
                        tickFormatter={caseTickFmt}
                        chart="case"
                        dailyCases={dailyCases}
                        monthNames={monthNames}
                        mean7dayCases={mean7dayCases}
                        percentChangeCases={percentChangeCases}
                        dailyDeaths={dailyDeaths}
                        mortalityMean={mortalityMean}
                        percentChangeMortality={percentChangeMortality}
                      />
                      <Grid.Row>
                ...
                >
                  ...
                  >
                    <Header.Content style={{ paddingLeft: 54 }}>
                      ...
                      >
                        Cases attributed to COVID-19 are rapidly rising in some
                        counties, and the geographic distribution of the
                        hardest-hit counties is changing. Approximately 50% of
                        new cases on{" "}
                        {monthNames[
                          new Date(
                            dataTS["_nation"][dataTS["_nation"].length - 1].t *
                        ...
                        in the United States were attributed to{" "}
                        {states50[0]["statenames"].split(",").length} states:{" "}
                        <br />
                        <br />
                        <center>
                          {" "}
                          <b style={{ fontSize: "18pt" }}>
                            {states50[0]["statenames"]}
                          </b>{" "}
                        </center>
                      </Header.Subheader>
                    </Header.Content>
                  ...
                  <Grid.Column style={{ width: 810, paddingLeft: 180 }}>
                    <div style={{ paddingTop: "0em" }}>
                      ...
                      >
                        <center>
                          {" "}
                          <b style={{ paddingLeft: 20, fontSize: "18pt" }}>
                            {" "}
                            COVID-19 Cases and U.S. Population <br />{" "}
                      ...
                      <div style={{ paddingTop: 10, paddingLeft: 80 }}>
                        ...
                        >
                          ...
                          <p style={{ paddingLeft: 20 }}>
                            Comparing with White Americans
                            <br />
                            <ul>
                              <li>
                                {" "}
                              ...
                              <li>
                                ...
                                Hispanic Americans:{" "}
                                {(
                                  nationalDemog["race"][0]["Hispanic"][0][
                                    "caserate"
                                  ] /
                                  nationalDemog["race"][0]["White"][0][
                                    "caserate"
                              ...
                              <li>
                                ...
                                Multi-Racial:{" "}
                                {(
                                  nationalDemog["race"][0]["Multiple/Other"][0][
                                    "caserate"
                                  ] /
                                  nationalDemog["race"][0]["White"][0][
                                    "caserate"
                          ...
                          content: (
                            <div style={{ fontSize: "19px", paddingLeft: 5 }}>
                              ...
                              >
                                ...
                                >
                                  The United States reports cases by combined
                                  race and ethnicity groups. The chart shows
                                  race and ethnicity groups that constitute at
                                  least 1% of the state population and have 30
                                  or more cases. Race and ethnicity data are
                                  known for{" "}
                                  {nationalDemog["race"][0]["Unknown"][0][
                                    "availableCases"
                                  ] + "%"}{" "}
                                  ...
                                  <a
                                    style={{ color: "#397AB9" }}
                                    href="https://www.cdc.gov/diabetes/data/index.html"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                  >
                                    {" "}
                                  ...
                                  <br />
                                  <b>
                                    Cases by Race & Ethnicity data as of:
                                  </b>{" "}
                                  {nationalDemogDate}.<br />
                                </Header.Content>
                              </Grid.Row>
                            </div>
                          ),
                  ...
                  <Grid.Column style={{ width: 810, paddingLeft: 330 }}>
                    <div style={{ paddingTop: 0 }}>
                      ...
                      >
                        <center>
                          {" "}
                          <b style={{ width: 560, fontSize: "18pt" }}>
                            {" "}
                            COVID-19 Death Rate by Race & Ethnicity
                          </b>{" "}
                        </center>
                      </Header.Subheader>
                    </div>
                  ...
                  <Grid.Row columns={2} style={{ width: 1000 }}>
                    <Grid.Column style={{ width: 450, paddingLeft: 120 }}>
                      <div style={{ paddingLeft: "6em", paddingRight: "0em" }}>
                        ...
                        >
                          ...
                          <VictoryGroup offset={13}>
                            <VictoryBar
                              ...
                              labels={({ datum }) =>
                                numberWithCommas(
                                  parseFloat(datum.value).toFixed(0) <= 1
                                    ? parseFloat(datum.value).toFixed(1)
                                    : parseFloat(datum.value).toFixed(0)
                                )
                              }
                              data={[
                                {
                                  key: nationalDemog["race"][0][
                                    "Multiple/Other"
                                  ][0]["demogLabel"],
                                  value:
                                    nationalDemog["race"][0][
                                ...
                                {
                                  key: nationalDemog["race"][0]["NHPI"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["race"][0]["NHPI"][0][
                                ...
                                {
                                  key: nationalDemog["race"][0]["Asian"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["race"][0]["Asian"][0][
                                ...
                                {
                                  key: nationalDemog["race"][0]["Hispanic"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["race"][0]["Hispanic"][0][
                                ...
                                {
                                  key: nationalDemog["race"][0]["White"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["race"][0]["White"][0][
                        ...
                        <Header.Content
                          style={{ paddingLeft: 160, width: 450 }}
                        >
                          <Header.Content
                            style={{
                              fontWeight: 300,
                                  ...
                                  content: (
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        >
                                          The United States reports deaths by
                                          combined race and ethnicity groups.
                                          The chart shows race and ethnicity
                                          groups that constitute at least 1% of
                                          the state population and have 30 or
                                          more deaths. Race and ethnicity data
                                          are known for{" "}
                                          {nationalDemog["race"][0][
                                            "Unknown"
                                          ][0]["availableDeaths"] + "%"}{" "}
                                          ...
                                          <br />
                                          <b>
                                            Deaths by Race & Ethnicity data as
                                            of:
                                          </b>{" "}
                                          {nationalDemogDate}.<br />
                                        </Header.Subheader>
                    ...
                    <Grid.Column style={{ width: 450 }}>
                      ...
                      <div style={{ paddingLeft: 140, paddingRight: "0em" }}>
                        ...
                        >
                          ...
                          <p style={{ paddingLeft: 20 }}>
                            Compared with death rates in White Americans, death
                            rates* are: <br />
                            <ul>
                              <li>
                                {(
                              ...
                              <li>
                                ...
                                {(
                                  ...
                                  ? "times lower"
                                  : "times higher"}{" "}
                                in Native Hawaiian and Pacific Islanders
                              </li>
                              <li>
                                {(
                                  nationalDemog["race"][0]["Multiple/Other"][0][
                                ...
                                {(
                                  ...
                                  ? "times lower"
                                  : "times higher"}{" "}
                                in the Multiple/Other race group
                              </li>
                            </ul>
                            <text style={{ fontSize: "13px" }}>
                              *The Hispanic population consists of mostly
                              younger age groups.
                              <br />
                              *These are crude death rates based on cumulative
                              deaths since January 2020. Age differences, such
                              as the lower average age of Hispanic Americans,
                              are not considered due to data limitations.
                            </text>
                            {/* While people of all races, ages, and sex are impacted by COVID-19, some subgroups are disproportionally 
                              affected. {Object.keys(demog_descriptives['Race'][0])[0]} are seeing the largest mortality rate, with {numberWithCommas((demog_descriptives['Race'][0][Object.keys(demog_descriptives['Race'][0])[0]]).toFixed(0))} cases per 100K individuals, 
                              around {(demog_descriptives['Race'][0][Object.keys(demog_descriptives['Race'][0])[0]] / demog_descriptives['Race'][0][Object.keys(demog_descriptives['Race'][0])[1]]).toFixed(0)} times that of {Object.keys(demog_descriptives['Race'][0])[1]}, the groups with the lowest mortality rate.  */}
                ...
                <center style={{ paddingLeft: 190 }}>
                  {" "}
                  <Divider style={{ width: 900, paddingTop: 0 }} />{" "}
                </center>
                ...
                >
                  ...
                  >
                    <Header.Content style={{ paddingLeft: 50 }}>
                      ...
                      >
                        Cases are currently highest in the{" "}
                        {Object.keys(demog_descriptives["Age"][0]["cases"])[0]}{" "}
                        age group (
                        {numberWithCommas(
                          demog_descriptives["Age"][0]["cases"][
                            Object.keys(
                              demog_descriptives["Age"][0]["cases"]
                            )[0]
                          ].toFixed(0)
                        )}
                        % of all cases), followed by the{" "}
                        {Object.keys(demog_descriptives["Age"][0]["cases"])[1]}{" "}
                        age group (
                        {numberWithCommas(
                          demog_descriptives["Age"][0]["cases"][
                            Object.keys(
                        ...
                        % of all cases).
                        {demog_descriptives["AgeDescription"][0][
                          "CasesDescription"
                        ] != ""
                          ? " They are disproportionately high in the " +
                            demog_descriptives["AgeDescription"][0][
                              "CasesDescription"
                            ] +
                            ", compared to those age groups' shares of the U.S. population."
                          : ""}
                        <br />
                        <br />
                        The prevalence of death increases with age and are
                        highest in the{" "}
                        {
                          Object.keys(demog_descriptives["Age"][1]["deaths"])[0]
                        }{" "}
                        age group (
                        {numberWithCommas(
                          demog_descriptives["Age"][1]["deaths"][
                            Object.keys(
                              demog_descriptives["Age"][1]["deaths"]
                            )[0]
                          ].toFixed(0)
                        ...
                        {demog_descriptives["AgeDescription"][0][
                          ...
                          ? " Deaths are disproportionately high in the " +
                            demog_descriptives["AgeDescription"][1][
                              "DeathsDescription"
                            ] +
                            ", compared to those age groups' shares of the U.S. population."
                          : ""}
                ...
                <Grid style={{ paddingTop: 0, paddingBottom: 0 }}>
                  <Grid.Row style={{ width: 1000, paddingLeft: 305 }}>
                    <svg width="1000" height="40">
                      ...
                      />
                      <text x={65} y={30} style={{ fontSize: "19px" }}>
                        {" "}
                        Percent of Cases
                      </text>
                      <rect
                        ...
                        style={{
                          fill: mortalityColor[1],
                          strokeWidth: 1,
                          stroke: mortalityColor[1],
                        }}
                      />
                      <text x={275} y={30} style={{ fontSize: "19px" }}>
                        {" "}
                        Percent of Deaths{" "}
                      </text>
                      <rect
                      ...
                      />
                      <text x={480} y={30} style={{ fontSize: "19px" }}>
                        {" "}
                        ...
                        >
                          ...
                          <VictoryGroup offset={23}>
                            <VictoryBar
                              ...
                              data={[
                                {
                                  key: nationalDemog["age"][0]["0 - 4"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["age"][0]["0 - 4"][0][
                                      "percentCases"
                                    ],
                                },
                                {
                                  key: nationalDemog["age"][0]["5 - 11"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["age"][0]["5 - 11"][0][
                                      "percentCases"
                                    ],
                                },
                                {
                                  key: nationalDemog["age"][0]["12 - 15"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["age"][0]["12 - 15"][0][
                                      "percentCases"
                                    ],
                                },
                                {
                                  key: nationalDemog["age"][0]["16 - 17"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["age"][0]["16 - 17"][0][
                                      "percentCases"
                                    ],
                                },
                                {
                                  key: nationalDemog["age"][0]["18 - 29"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["age"][0]["18 - 29"][0][
                                      "percentCases"
                                    ],
                                },
                                {
                                  key: nationalDemog["age"][0]["30 - 39"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["age"][0]["30 - 39"][0][
                                      "percentCases"
                                    ],
                                },
                                {
                                  key: nationalDemog["age"][0]["40 - 49"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["age"][0]["40 - 49"][0][
                                      "percentCases"
                                    ],
                                },
                                {
                                  key: nationalDemog["age"][0]["50 - 64"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["age"][0]["50 - 64"][0][
                                      "percentCases"
                                    ],
                                },
                                {
                                  key: nationalDemog["age"][0]["65 - 74"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["age"][0]["65 - 74"][0][
                                      "percentCases"
                                    ],
                                },
                                {
                                  key: nationalDemog["age"][0]["75 - 84"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["age"][0]["75 - 84"][0][
                                      "percentCases"
                                    ],
                                },
                                {
                                  key: nationalDemog["age"][0]["85+"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["age"][0]["85+"][0][
                                      "percentCases"
                                    ],
                                },
                              ]}
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        <br />
                                        <b>Data as of:</b> {nationalDemogDate}.
                                        <br />
                                      </Header.Subheader>
                                    </Header.Content>
                                  </Header>
                  ...
                  <Grid.Row
                    style={{ width: 800, paddingLeft: 320, paddingTop: "1em" }}
                  >
                    <svg width="1000" height="40">
                      <rect
                        x={40}
                        ...
                        >
                          ...
                          <VictoryGroup offset={23}>
                            <VictoryBar
                              ...
                              data={[
                                {
                                  key: nationalDemog["sex"][0]["Male"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["sex"][0]["Male"][0][
                                ...
                                {
                                  key: nationalDemog["sex"][0]["Female"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["sex"][0]["Female"][0][
                                      "percentCases"
                                    ],
                                },
                              ]}
                ...
                {true && (
                  <div style={{ paddingLeft: "7em", paddingRight: "2em" }}>
                    <Header
                      as="h2"
                      style={{
                        color: "#b2b3b3",
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <center>
                            {" "}
                            <b style={{ fontSize: "18pt", paddingLeft: 18 }}>
                              COVID-19 cases per 100K by population
                              characteristics across all counties in the United
                              States{" "}
                            </b>{" "}
                          </center>
                          <br />
                          <br />
                          COVID-19 is affecting communities differently.
                          Community-level factors such as urbanicity,
                          socioeconomic status, race, and underlying medical
                          conditions make some communities more vulnerable to
                          COVID-19 than others. The maps and figures below show
                          COVID-19 case rates and death rates across U.S.
                          counties grouped by these community characteristics.
                        </Header.Subheader>
                      </Header.Content>
                    </Header>

                    <div id="ccvi" style={{ height: 45 }}>
                      {" "}
                    </div>
                    ...
                    <Grid>
                      <Grid.Row
                        columns={2}
                        style={{ paddingTop: 8, width: 1000, paddingLeft: 60 }}
                      >
                        <Grid.Column
                        ...
                        >
                          ...
                          >
                            <Header.Content style={{ padding: 0, width: 500 }}>
                              Community Vulnerability Ranking by County
                            </Header.Content>
                          </Header>
                          <div>
                            <svg
                            ...
                            >
                              {_.map(legendSplitccvi, (splitpoint, i) => {
                                if (legendSplitccvi[i] < 1) {
                                  ...
                                  return (
                                    ...
                                    >
                                      {" "}
                                      {(legendSplitccvi[i] / 1000000).toFixed(
                                        0
                                      ) + "M"}
                                    </text>
                                  );
                                  ...
                                  return (
                                    ...
                                    >
                                      {" "}
                                      {(legendSplitccvi[i] / 1000).toFixed(0) +
                                        "K"}
                                    </text>
                                  );
                                }
                                return (
                                  ...
                                  >
                                    {" "}
                                    {legendSplitccvi[i].toFixed(0)}
                                  </text>
                                );
                              })}
                              <text x={50} y={25} style={{ fontSize: "0.6em" }}>
                                {legendMinccvi}
                              </text>
                              <text
                                x={170}
                              ...
                              <text x={50} y={71} style={{ fontSize: "0.6em" }}>
                                Low
                              </text>
                              <text
                                x={50 + 19 * (colorPalette.length - 1)}
                                y={71}
                                style={{ fontSize: "0.6em" }}
                              >
                                High
                            ...
                            <Image
                              width="480"
                              height="230"
                              style={{ paddingLeft: 70, paddingTop: 0 }}
                              src="/NationalReportImages/ccvi2.png"
                            />
                                    ...
                                    content: (
                                      ...
                                      >
                                        ...
                                        >
                                          ...
                                          >
                                            This map shows each U.S. county
                                            according to its Community
                                            Vulnerability ranking. County
                                            rankings are based on quintiles of
                                            the COVID-19 Community Vulnerability
                                            Index (CCVI). The ranking classifies
                                            counties into five groups designed
                                            to be of equal size, so that the
                                            lowest quintile contains the
                                            counties with values in the 0%-20%
                                            range for this county
                                            characteristic, and the very high
                                            CCVI contains counties with values
                                            in the 80%-100% range for this
                                            county characteristic. Low CCVI
                                            indicates counties in the 20%-40%
                                            range, moderate CCVI indicates
                                            counties in the 40%-60% range, and
                                            high CCVI indicates counties in the
                                            60%-80% range.
                                            <br />
                                            <br />
                                            <i>Data source</i>:{" "}
                                            ...
                                            <br />
                                            For a complete table of definitions,
                                            click{" "}
                                            <a
                                              style={{ color: "#397AB9" }}
                            ...
                            >
                              <Header.Content
                                style={{ paddingLeft: 0, width: 500 }}
                              >
                                COVID-19 Vaccination by <br /> Community
                                Vulnerability Index
                              </Header.Content>
                            </Header>
                            <VictoryChart
                                ...
                                data={[
                                  {
                                    key: "Very Low",
                                    value: parseFloat(
                                      ccvidata["Very Low"]["vac_percent"]
                                    ),
                                  },
                                  {
                                    key: "Low",
                                    value: parseFloat(
                                      ccvidata["Low"]["vac_percent"]
                                    ),
                                  },
                                  {
                                    key: "Moderate",
                                    value: parseFloat(
                                      ccvidata["Moderate"]["vac_percent"]
                                    ),
                                  },
                                  {
                                    key: "High",
                                    value: parseFloat(
                                      ccvidata["High"]["vac_percent"]
                                    ),
                                  },
                                  {
                                    key: "Very High",
                                    value: parseFloat(
                                      ccvidata["Very High"]["vac_percent"]
                                    ),
                                  },
                                ]}
                                labelComponent={
                          ...
                          <Accordion
                            style={{ paddingTop: 0, paddingLeft: 60 }}
                            defaultActiveIndex={1}
                            panels={[
                              {
                                key: "acquire-dog",
                                  ...
                                  content: (
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        >
                                          This chart shows the percentage of the
                                          population with a full dose of the
                                          COVID-19 vaccination by COVID-19
                                          Community Vulnerability Index (CCVI).
                                          The y-axis displays CCVI rankings
                                          based on quintiles (groups of 20%).
                                          The x-axis displays the percentage of
                                          COVID-19 vaccination across US
                                          counties ranked by CCVI. The ranking
                                          classifies counties into five groups
                                          designed to be of equal size, so that
                                          the lowest quintile contains the
                                          counties with values in the 0%-20%
                                          range for this county characteristic,
                                          and the very high CCVI contains
                                          counties with values in the 80%-100%
                                          range for this county characteristic.
                                          Low CCVI indicates counties in the
                                          20%-40% range, moderate CCVI indicates
                                          counties in the 40%-60% range, and
                                          high CCVI indicates counties in the
                                          60%-80% range.
                                          <br />
                        ...
                        <Grid.Column style={{ paddingLeft: 100 }}>
                          ...
                          >
                            <Header.Content
                              style={{ paddingLeft: 0, width: 500 }}
                            >
                              COVID-19 Cases by <br /> Community Vulnerability
                              Index
                            </Header.Content>
                          </Header>
                          <br />
                          ...
                          >
                            ...
                            <VictoryBar
                              ...
                              data={[
                                {
                                  key: nationalBarChart["caserate"][0][
                                    "ccvi"
                                  ][0]["label"],
                                  value:
                                    (nationalBarChart["caserate"][0]["ccvi"][0][
                                      "measure"
                                    ] /
                                      nationalBarChart["caserate"][0][
                                        "ccvi"
                                      ][0]["measure"]) *
                                      nationalBarChart["caserate"][0][
                                        "ccvi"
                                ...
                                },
                                {
                                  ...
                                  value:
                                    (nationalBarChart["caserate"][0]["ccvi"][1][
                                      "measure"
                                    ] /
                                      nationalBarChart["caserate"][0][
                                        "ccvi"
                                ...
                                },
                                {
                                  ...
                                  value:
                                    (nationalBarChart["caserate"][0]["ccvi"][2][
                                      "measure"
                                    ] /
                                      nationalBarChart["caserate"][0][
                                        "ccvi"
                                ...
                                },
                                {
                                  ...
                                  value:
                                    (nationalBarChart["caserate"][0]["ccvi"][3][
                                      "measure"
                                    ] /
                                      nationalBarChart["caserate"][0][
                                        "ccvi"
                                ...
                                },
                                {
                                  ...
                                  value:
                                    (nationalBarChart["caserate"][0]["ccvi"][4][
                                      "measure"
                                    ] /
                                      nationalBarChart["caserate"][0][
                                        "ccvi"
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        >
                                          ...
                                          COVID-19 cases per 100K residents by
                                          COVID-19 Community Vulnerability Index
                                          (CCVI) ranking. The y-axis displays
                                          CCVI rankings based on quintiles
                                          (groups of 20%). The x-axis displays
                                          the average number of COVID-19 cases
                                          (top chart) per 100K that occurred in
                                          each group of counties ranked by CCVI.
                                          The ranking classifies counties into
                                          five groups designed to be of equal
                                          size, so that the lowest quintile
                                          contains the counties with values in
                                          the 0%-20% range for this county
                                          characteristic, and the very high CCVI
                                          contains counties with values in the
                                          80%-100% range for this county
                                          characteristic. Low CCVI indicates
                                          counties in the 20%-40% range,
                                          moderate CCVI indicates counties in
                                          the 40%-60% range, and high CCVI
                                          indicates counties in the 60%-80%
                                          range.
                                          <br />
                                          <br />
                                          For a complete table of definitions,
                          ...
                          >
                            <Header.Content
                              style={{ paddingLeft: 0, width: 500 }}
                            >
                              COVID-19 Deaths by <br /> Community Vulnerability
                              Index
                            </Header.Content>
                          </Header>
                          <VictoryChart
                          ...
                          >
                            ...
                            <VictoryBar
                              ...
                              data={[
                                {
                                  key: nationalBarChart["covidmortality"][0][
                                    "ccvi"
                                  ][0]["label"],
                                  value:
                                    (nationalBarChart["covidmortality"][0][
                                      "ccvi"
                                    ][0]["measure"] /
                                      nationalBarChart["covidmortality"][0][
                                        "ccvi"
                                    ...
                                    content: (
                                      ...
                                      >
                                        ...
                                        >
                                          ...
                                          >
                                            This chart shows the number of
                                            COVID-19 deaths (bottom chart) per
                                            100K residents by COVID-19 Community
                                            Vulnerability Index (CCVI) ranking.
                                            The y-axis displays CCVI rankings
                                            based on quintiles (groups of 20%).
                                            The x-axis displays the average
                                            number of COVID-19 deaths (bottom
                                            chart) per 100K that occurred in
                                            each group of counties ranked by
                                            CCVI. The ranking classifies
                                            counties into five groups designed
                                            to be of equal size, so that the
                                            lowest quintile contains the
                                            counties with values in the 0%-20%
                    ...
                    <div id="poverty" style={{ height: 45 }}>
                      {" "}
                    </div>

                    <center style={{ paddingLeft: 90 }}>
                      <Divider style={{ width: 900 }} />{" "}
                    </center>
                    ...
                    >
                      <center>
                        {" "}
                        <b style={{ fontSize: "18pt", paddingLeft: 134 }}>
                          ...
                          >
                            ...
                            <div>
                                ...
                                {_.map(legendSplitPoverty, (splitpoint, i) => {
                                  if (legendSplitPoverty[i] < 1) {
                                    return (
                                      ...
                                      >
                                        {" "}
                                        {legendSplitPoverty[i].toFixed(1)}
                                      </text>
                                    );
                                    ...
                                    return (
                                      ...
                                      >
                                        {" "}
                                        {(legendSplitPoverty[i] / 1000).toFixed(
                                          0
                                        ) + "K"}
                                      </text>
                                    );
                                  ...
                                  return (
                                    ...
                                    >
                                      {" "}
                                      {legendSplitPoverty[i].toFixed(0)}
                                    </text>
                                  );
                                })}
                                <text
                              ...
                              <Image
                                ...
                                height="230"
                                style={{ paddingLeft: 70, paddingTop: 0 }}
                                src="/NationalReportImages/poverty2.png"
                              />
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              population in poverty. County
                                              rankings are based on quintiles of
                                              percentage of population in
                                              poverty. The ranking classifies
                                              counties into five groups designed
                                              to be of equal size, so that the
                                              "very low % in poverty" group
                                              contains the counties with values
                                              in the 0%-20% range for this
                                              county characteristic, and the
                                              "very high % in poverty" group
                                              contains counties with values in
                                              the 80%-100% range for this county
                                              characteristic. Low % in poverty
                                              indicates counties in the 20%-40%
                                              range, moderate % in poverty
                                              indicates counties in the 40%-60%
                                              range, and high % in poverty
                                              indicates counties in the 60%-80%
                                              range.
                                              <br />
                                              <br />
                                  ...
                                  data={[
                                    {
                                      key: "Very Low",
                                      value: parseFloat(
                                        barData["Series_Complete_Pop_Pct"][0][
                                          "poverty"
                                        ][0]["measure"]
                                      ),
                                    },
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              >
                                                ...
                                                of the population with a full
                                                dose of the COVID-19 vaccination
                                                by poverty. The y-axis displays
                                                population in poverty based on
                                                quintiles (groups of 20%). The
                                                x-axis displays the percentage
                                                of COVID-19 vaccination across
                                                US counties ranked by percentage
                                                population in poverty. The
                                                ranking classifies counties into
                                                five groups designed to be of
                                                equal size, so that the "very
                                                low % in poverty" group contains
                                                the counties with values in the
                                                0%-20% range for this county
                                                characteristic, and the "very
                                                high % in poverty" group
                                                contains counties with values in
                                                the 80%-100% range for this
                                                county characteristic. Low % in
                                                poverty indicates counties in
                                                the 20%-40% range, moderate % in
                                                poverty indicates counties in
                                                the 40%-60% range, and high % in
                                                poverty indicates counties in
                                                the 60%-80% range.
                                                <br />
                                                <br />
                          ...
                          <Grid.Column>
                            ...
                            >
                              <Header.Content
                                style={{ paddingLeft: 0, width: 500 }}
                              >
                                COVID-19 Cases by Percentage of <br />{" "}
                                Population in Poverty
                              </Header.Content>
                            </Header>
                            <br />
                                      ...
                                      content: (
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            >
                                              This chart shows the number of
                                              COVID-19 cases (top chart) per
                                              100K residents by county ranking
                                              on percentage of population in
                                              poverty. The y-axis displays
                                              percentage population in poverty
                                              rankings based on quintiles
                                              (groups of 20%). The x-axis
                                              displays the average number of
                                              COVID-19 cases (top chart) per
                                              100K that occurred in each group
                                              of counties ranked by percentage
                                              population in poverty. The ranking
                                              classifies counties into five
                                              groups designed to be of equal
                                              size, so that the "very low % in
                                              poverty" group contains the
                                              counties with values in the 0%-20%
                                              range for this county
                                              characteristic, and the "very high
                                              % in poverty" group contains
                                              counties with values in the
                                              80%-100% range for this county
                                              characteristic. Low % in poverty
                                              indicates counties in the 20%-40%
                                              range, moderate % in poverty
                            ...
                            >
                              <Header.Content
                                style={{ paddingLeft: 0, width: 500 }}
                              >
                                COVID-19 Deaths by Percentage of <br />{" "}
                                Population in Poverty
                              </Header.Content>
                            </Header>
                            <VictoryChart
                        ...
                        >
                          <Grid.Column style={{ paddingLeft: 0 }}>
                                ...
                                <Grid.Row columns={2}>
                                  ...
                                  <Grid.Column width={11}>
                                    <Image
                                      height="200"
                                      style={{ paddingLeft: 0 }}
                                      src="/NationalReportImages/urbanrural2.png"
                                    />
                                  </Grid.Column>
                                </Grid.Row>
                              </Grid>
                            ...
                            <Grid>
                              <Grid.Row>
                                <Accordion
                                  style={{ paddingTop: 25, paddingLeft: 60 }}
                                  defaultActiveIndex={1}
                                  panels={[
                                    {
                                      key: "acquire-dog",
                                        ...
                                        content: (
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              >
                                                This map shows each U.S. county
                                                according to its metropolitan
                                                status. Inner city counties have
                                                &#60; 1 million population or
                                                contain the entire or large part
                                                of the population of the largest
                                                principal city. Large suburban
                                                counties have a population &#60;
                                                1 million, but do not qualify as
                                                inner cities. Small suburban
                                                counties have a population of
                                                250,000-999,999. Small cities
                                                have populations &#62; 250,000
                                                and are near large cities. Rural
                                                areas near cities have an
                                                urbanized area with a population
                                                between 10,000-49,999. Remote
                                                ...
                                                <a
                                                  style={{ color: "#397AB9" }}
                                                  href="https://www.cdc.gov/nchs/data_access/urban_rural.htm"
                                                  target="_blank"
                                                  rel="noopener noreferrer"
                                                >
                                                  {" "}
                            ...
                            >
                              <Header.Content
                                style={{ paddingLeft: 0, width: 500 }}
                              >
                                COVID-19 Vaccination by <br /> Metropolitan
                                Status
                              </Header.Content>
                            </Header>
                            <VictoryChart
                                      ...
                                      >
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            the population with a full dose of
                                            the COVID-19 vaccination by
                                            Metropolitan Status (y-axis). Inner
                                            city counties have &#60; 1 million
                                            population or contain the entire or
                                            large part of the population of the
                                            largest principle city. Large
                                            suburban counties have a population
                                            &#60; 1 million, but do not qualify
                                            as inner city. Small suburban
                                            counties have a population of
                                            250,000-999,999. Small cities have
                                            populations &#62; 250,000 and are
                                            near large cities. Rural areas near
                                            cities have an urbanized area with
                                            population between 10,000-49,999.
                                            Remote rural counties have
                                            populations less than 10,000
                                            individuals. This urban-rural
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            >
                                              This chart shows the number of
                                              COVID-19 cases (top chart) per
                                              100K residents by metropolitan
                                              status (y-axis). Inner city
                                              counties have &#60; 1 million
                                              population or contain the entire
                                              or large part of the population of
                                              the largest principle city. Large
                                              suburban counties have a
                                              population &#60; 1 million, but do
                                              not qualify as inner city. Small
                                              suburban counties have a
                                              population of 250,000-999,999.
                                              Small cities have populations
                                              &#62; 250,000 and are near large
                                              cities. Rural areas near cities
                                              have an urbanized area with
                                              population between 10,000-49,999.
                                              Remote rural counties have
                                              populations less than 10,000
                                              individuals. This urban-rural
...
<text x={152} y={40} style={{fontSize: '0.8em'}}> Reported </text> */}
                                  ...
                                  <Grid.Column width={11}>
                                    <Image
                                      height="210"
                                      style={{ paddingLeft: 0 }}
                                      src="/NationalReportImages/region2.png"
                                    />
                                  </Grid.Column>
                                </Grid.Row>
                              </Grid>
                                        ...
                                        content: (
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              >
                                                This map shows US by geographic
                                                region.
                                                <br />
                                                <br />
                                                <i>Data source</i>:{" "}
                                                <a
                                                  style={{ color: "#397AB9" }}
                                                  href="https://www.census.gov/geographies/reference-maps/2010/geo/2010-census-regions-and-divisions-of-the-united-states.html"
                                                  target="_blank"
                                                  rel="noopener noreferrer"
                                                >
                                                  {" "}
                                      ...
                                      >
                                        ...
                                        >
                                          ...
                                          >
                                            This chart shows the percentage of
                                            the population with a full dose of
                                            the COVID-19 vaccination geographic
                                            region (y-axis).
                                            <br />
                                            <br />
                                            For a complete table of definitions,
                                      ...
                                      content: (
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            >
                                              This chart shows the number of
                                              COVID-19 and deaths (bottom chart)
                                              per 100K residents by geographic
                                              region (y-axis).
                                              <br />
                                              <br />
                                              For a complete table of
                          ...
                          >
                            ...
                            <div>
                                ...
                                {_.map(legendSplitBlack, (splitpoint, i) => {
                                  if (legendSplitBlack[i] < 1) {
                                    ...
                                    return (
                                      ...
                                      >
                                        {" "}
                                        {(legendSplitBlack[i] / 1000).toFixed(
                                          0
                                        ) + "K"}
                                      </text>
                                    );
                              ...
                              <Image
                                ...
                                height="230"
                                style={{ paddingLeft: 70, paddingTop: 0 }}
                                src="/NationalReportImages/black2.png"
                              />
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              according to its percentage of
                                              African American population.
                                              County rankings are based on
                                              quintiles of percentage of African
                                              American population. The ranking
                                              classifies counties into five
                                              groups designed to be of equal
                                              size, so that the "very low %
                                              African American" group contains
                                              the counties with values in the
                                              0%-20% range for this county
                                              characteristic, and the "very high
                                              % African American" group contains
                                              counties with values in the
                                              80%-100% range for this county
                                              characteristic. Low % African
                                              American indicates counties in the
                                              20%-40% range, moderate % African
                                              American indicates counties in the
                              ...
                              >
                                <Header.Content
                                  style={{ paddingLeft: 0, width: 500 }}
                                >
                                  COVID-19 Vaccination by <br /> African
                                  American Population
                                </Header.Content>
                              </Header>
                              <VictoryChart
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              >
                                                ...
                                                of the population with a full
                                                dose of the COVID-19 vaccination
                                                by percentage African American.
                                                The y-axis displays African
                                                American population based on
                                                quintiles (groups of 20%). The
                                                x-axis displays the percentage
                                                of COVID-19 vaccination across
                                                US counties ranked by percentage
                                                African American. The ranking
                                                classifies counties into five
                                                groups designed to be of equal
                                                size, so that the "very low %
                                                African American" group contains
                                                ...
                                                0%-20% range for this county
                                                characteristic, and the "very
                                                high % African American" group
                                                contains counties with values in
                                                the 80%-100% range for this
                                                county characteristic. Low %
                                                African American indicates
                                                counties in the 20%-40% range,
                                                moderate % African American
                                                indicates counties in the
                                                40%-60% range, and high %
                                                African American indicates
                          ...
                          <Grid.Column>
                            ...
                            >
                              <Header.Content
                                style={{ paddingLeft: 0, width: 500 }}
                              >
                                COVID-19 Cases by Percentage of <br /> African
                                American Population
                              </Header.Content>
                            </Header>
                            <br />
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            >
                                              This chart shows the number of
                                              COVID-19 cases (top chart) per
                                              100K residents by percentage
                                              African American population
                                              ranking. The y-axis displays
                                              percentage African American
                                              population rankings based on
                                              quintiles (groups of 20%). The
                                              x-axis displays the average number
                                              of COVID-19 cases (top chart) per
                                              100K that occurred in each group
                                              of counties ranked by percentage
                                              percentage African American. The
                                              ranking classifies counties into
                                              five groups designed to be of
                                              equal size, so that the "very low
                                              % African American" group contains
                                              the counties with values in the
                                              0%-20% range for this county
                                              characteristic, and the "very high
                            ...
                            >
                              <Header.Content
                                style={{ paddingLeft: 0, width: 500 }}
                              >
                                COVID-19 Deaths by Percentage of <br /> African
                                American Population
                              </Header.Content>
                            </Header>
                            <VictoryChart
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              quintiles (groups of 20%). The
                                              x-axis displays the average number
                                              of COVID-19 deaths (bottom chart)
                                              per 100K that occurred in each
                                              group of counties ranked by
                                              percentage percentage African
                                              American. The ranking classifies
                                              counties into five groups designed
                                              to be of equal size, so that the
                                              "very low % African American"
                                              group contains the counties with
                                              values in the 0%-20% range for
                                              this county characteristic, and
                                              the "very high % African American"
                                              group contains counties with
                                              values in the 80%-100% range for
                                              this county characteristic. Low %
                                              African American indicates
                                              counties in the 20%-40% range,
                                              moderate % African American
                                              indicates counties in the 40%-60%
                                              range, and high % African American
                                              indicates counties in the 60%-80%
                                              range.
                                              <br />
                                              <br />
                          ...
                          >
                            ...
                            >
                              <Header.Content
                                style={{ padding: 0, width: 500 }}
                              >
                                Residential Segregation by County
                              </Header.Content>
                            </Header>
                            <div>
                              <svg
                                ...
                                {_.map(legendSplitResSeg, (splitpoint, i) => {
                                  if (legendSplitResSeg[i] < 1) {
                                    ...
                                    return (
                                      ...
                                      >
                                        {" "}
                                        {(legendSplitResSeg[i] / 1000).toFixed(
                                          0
                                        ) + "K"}
                                      </text>
                                    );
                              ...
                              <Image
                                ...
                                height="230"
                                style={{ paddingLeft: 70, paddingTop: 0 }}
                                src="/NationalReportImages/resSeg2.png"
                              />
                                      ...
                                      content: (
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            >
                                              This map shows each U.S. county
                                              according to its racial
                                              segregation ranking. County
                                              rankings are based on quintiles of
                                              the racial segregation index. The
                                              ranking classifies counties into
                                              five groups designed to be of
                                              equal size, so that the "very low
                                              segregation" group contains the
                                              counties with values in the 0%-20%
                                              range for this county
                                              characteristic, and the "very high
                                              segregation" group contains
                                              counties with values in the
                                              80%-100% range for this county
                                              characteristic. Low segregation
                                              indicates counties in the 20%-40%
                                              range, moderate segregation
                                              indicates counties in the 40%-60%
                                              range, and high segregation
                                              indicates counties in the 60%-80%
                                              range.
                                              <br />
                                              <br />
                                              ...
                                              <a
                                                style={{ color: "#397AB9" }}
                                                href="https://www.countyhealthrankings.org/explore-health-rankings/measures-data-sources/county-health-rankings-model/health-factors/social-and-economic-factors/family-social-support/residential-segregation-blackwhite"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                              >
                                                {" "}
                              ...
                              >
                                <Header.Content
                                  style={{ paddingLeft: 0, width: 500 }}
                                >
                                  COVID-19 Vaccination by <br /> Residential
                                  Segregation Index
                                </Header.Content>
                              </Header>
                              <VictoryChart
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              >
                                                ...
                                                of the population with a full
                                                dose of the COVID-19 vaccination
                                                by residential segregation. The
                                                y-axis displays residential
                                                segregation rankings based on
                                                quintiles (groups of 20%). The
                                                x-axis displays the percentage
                                                of COVID-19 vaccination across
                                                US counties ranked by
                                                residential segregation. The
                                                ranking classifies counties into
                                                five groups designed to be of
                                                equal size, so that the "very
                                                low segregation" group contains
                                                the counties with values in the
                                                0%-20% range for this county
                                                characteristic, and the "very
                                                high segregation" group contains
                                                counties with values in the
                                                80%-100% range for this county
                                                characteristic. Low segregation
                                                indicates counties in the
                                                20%-40% range, moderate
                                                segregation indicates counties
                          ...
                          <Grid.Column>
                            ...
                            >
                              <Header.Content
                                style={{ paddingLeft: 0, width: 500 }}
                              >
                                COVID-19 Cases by <br /> Residential Segregation
                                Index
                              </Header.Content>
                            </Header>
                            <br />
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            >
                                              This chart shows the number of
                                              COVID-19 cases (top chart) per
                                              100K residents by residential
                                              segregation index. The y-axis
                                              displays residential segregation
                                              rankings based on quintiles
                                              (groups of 20%). The x-axis
                                              displays the average number of
                                              COVID-19 cases (top chart) per
                                              100K that occurred in each group
                                              of counties ranked by residential
                                              segregation. The ranking
                                              classifies counties into five
                                              groups designed to be of equal
                                              size, so that the "very low
                                              segregation" group contains the
                            ...
                            >
                              <Header.Content
                                style={{ paddingLeft: 0, width: 500 }}
                              >
                                COVID-19 Deaths by <br /> Residential
                                Segregation Index
                              </Header.Content>
                            </Header>
                            <VictoryChart
                          ...
                          >
                            ...
                            >
                              <Header.Content
                                style={{ padding: 0, width: 500 }}
                              >
                                Any Underlying Comorbidity By County
                              </Header.Content>
                            </Header>
                            <div>
                              <svg
                                ...
                                {_.map(legendSplitComorb, (splitpoint, i) => {
                                  if (legendSplitComorb[i] < 1) {
                                    ...
                                    return (
                                      ...
                                      >
                                        {" "}
                                        {(legendSplitComorb[i] / 1000).toFixed(
                                          0
                                        ) + "K"}
                                      </text>
                                    );
                              ...
                              <Image
                                ...
                                height="230"
                                style={{ paddingLeft: 70, paddingTop: 0 }}
                                src="/NationalReportImages/anycondition2.png"
                              />
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              population with underlying
                                              conditions. County rankings are
                                              based on quintiles of percentage
                                              of population with underlying
                                              conditions. The ranking classifies
                                              counties into five groups designed
                                              to be of equal size, so that the
                                              population with "very low
                                              percentage of any underlying
                                              comorbidity" group contains the
                                              counties with values in the 0%-20%
                                              range for this county
                                              characteristic, and the population
                                              with "very high percentage of any
                                              underlying comorbidity" group
                                              contains counties with values in
                                              the 80%-100% range for this county
                                              characteristic. Low percentage of
                                              population with any underlying
                                              comorbidity indicates counties in
                                              the 20%-40% range, moderate
                                              percentage of population with any
                                              underlying comorbidity indicates
                                              counties in the 40%-60% range, and
                                              ...
                                              <a
                                                style={{ color: "#397AB9" }}
                                                href="https://stacks.cdc.gov/"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                              >
                                                {" "}
                                                CDC Stacks Public Health
                                                Publicatiions
                                              </a>
                                              <br />
                                              For a complete table of
                              ...
                              >
                                <Header.Content
                                  style={{ paddingLeft: 0, width: 500 }}
                                >
                                  COVID-19 Vaccination by <br /> Underlying
                                  Comorbidity
                                </Header.Content>
                              </Header>
                              <br />
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              >
                                                ...
                                                of the population with a full
                                                dose of the COVID-19 vaccination
                                                by underlying comorbidity. The
                                                y-axis displays underlying
                                                comorbidity rankings based on
                                                quintiles (groups of 20%). The
                                                x-axis displays the percentage
                                                of COVID-19 vaccination across
                                                US counties ranked by percent of
                                                population with any underlying
                                                comorbidity. The ranking
                                                classifies counties into five
                                                groups designed to be of equal
                                                size, so that the population
                                                with "very low percentage of any
                                                underlying comorbidity" group
                                                contains the counties with
                                                values in the 0%-20% range for
                                                this county characteristic, and
                                                the population with "very high
                                                percentage of any underlying
                                                comorbidity" group contains
                                                counties with values in the
                                                80%-100% range for this county
                                                characteristic. Low percentage
                                                of population with any
                                                underlying comorbidity indicates
                                                counties in the 20%-40% range,
                                                moderate percentage of
                                                population with any underlying
                                                comorbidity indicates counties
                                                in the 40%-60% range, and high
                          ...
                          <Grid.Column>
                            ...
                            >
                              <Header.Content
                                style={{ paddingLeft: 0, width: 500 }}
                              >
                                COVID-19 Cases by <br /> Any Underlying
                                Comorbidity
                              </Header.Content>
                            </Header>
                            <br />
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            >
                                              This chart shows the number of
                                              COVID-19 cases (top chart) per
                                              100K residents by percent of
                                              population with any underlying
                                              comorbidity. The y-axis displays
                                              percent of population with any
                                              underlying comorbidity rankings
                                              based on quintiles (groups of
                                              20%). The x-axis displays the
                                              average number of COVID-19 cases
                                              (top chart) per 100K that occurred
                                              in each group of counties ranked
                                              by percent of population with any
                                              underlying comorbidity. The
                                              ranking classifies counties into
                                              five groups designed to be of
                                              equal size, so that the population
                                              with "very low percentage of any
                                              underlying comorbidity" group
                                              contains the counties with values
                                              in the 0%-20% range for this
                            ...
                            >
                              <Header.Content
                                style={{ paddingLeft: 0, width: 500 }}
                              >
                                COVID-19 Deaths by <br /> Any Underlying
                                Comorbidity
                              </Header.Content>
                            </Header>
                            <VictoryChart
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              based on quintiles (groups of
                                              20%). The x-axis displays the
                                              average number of COVID-19 deaths
                                              (bottom chart) per 100K that
                                              occurred in each group of counties
                                              ranked by percent of population
                                              with any underlying comorbidity.
                                              The ranking classifies counties
                                              into five groups designed to be of
                                              equal size, so that the population
                                              with "very low percentage of any
                                              underlying comorbidity" group
                                              contains the counties with values
