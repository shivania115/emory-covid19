...
const nameList = [
  ...
  "State Vaccination Tracker",
  "State COVID-19 Burden",
  "General Information",
  "Vaccine Development",
  "Vaccine Safety",
  "Getting Vaccinated",
        ...
        <Rail attached size="mini" style={{ width: 250 }}>
          <Sticky offset={180} position="fixed" context={contextRef}>
            ...
            >
              ...
              >
                <Header as="h4">{nameList[9]}</Header>
              </Menu.Item>
              ...
              >
                <Header as="h4">{nameList[8]}</Header>
              </Menu.Item>
              <Menu.Item
                as="a"
                href="#general"
  ...
  componentDidMount() {
    fetch("/data/nationalDemogdata.json")
      ...
      .then((data) =>
        this.setState({
          dataTot: [
            data["vaccineRace"][0]["Hispanic"][0],
            data["vaccineRace"][0]["Asian"][0],
            data["vaccineRace"][0]["American Native"][0],
            data["vaccineRace"][0]["African American"][0],
    ...
    return (
      ...
      >
        <Pie
          ...
          fill="#8884d8"
          dataKey={
            this.props.pop == true ? "percentPop" : "seriesCompletePopPctKnown"
          }
        ...
        >
          ...
          <Label
            value={this.props.pop == true ? "Population" : "Fully Vaccinated"}
            position="center"
          />
        </Pie>
      </PieChart>
  ...
  if (active && payload && payload.length) {
    return (
      <div className="custom-tooltip" style={{ lineHeight: "19px" }}>
        ...
        <p
          style={{ margin: 0, color: colorPaletteGraph[0] }}
          className="intro"
        >{`Percent vaccinated (at least 1 dose): ${payload[1].value.toFixed(
          1
        )}`}</p>
        <p
          style={{ margin: 0, color: colorPaletteGraph[4] }}
          className="intro"
        ...
        {payload.length > 3 && (
          <p
            style={{ margin: 0, color: colorPaletteGraph[2] }}
            className="intro"
        ...
        {payload.length > 3 && (
          <p
            style={{ margin: 0, color: colorPaletteGraph[3] }}
            className="intro"
        ...
        {payload.length > 5 && (
          <p
            style={{ margin: 0, color: colorPaletteGraph[1] }}
            className="intro"
        ...
        {payload.length > 5 && (
          <p
            style={{ margin: 0, color: colorPaletteGraph[5] }}
            className="intro"
  ...
  return (
    <div style={{ fontSize: "19px" }}>
      ...
      <center>
        <p>
          {" "}
          Percent vaccinated with at least 1 dose by Community Characteristics
        </p>
      </center>
      <LineChart
        width={720}
            ...
            (props.selection === "region" ||
              ...
              : [
                  ...
                  },
                  {
                    ...
                    type: "square",
                    color: colorPaletteGraph[1],
                  },
                  {
                    id: "6",
                    value: props.trendGroup[5],
                    type: "square",
                    color: colorPaletteGraph[5],
                  },
                ]
          }
        />
  ...
  const data = [
    {
      ...
      weeksvalue:
        props.twoweeksvac["nation"]["White"]["pctAmongFullyVasLast14"] < 0
          ? 0
    ...
    },
    {
      ...
      weeksvalue:
        props.twoweeksvac["nation"]["Hispanic"]["pctAmongFullyVasLast14"] < 0
          ? 0
...

    {
      ...
      weeksvalue:
        props.twoweeksvac["nation"]["African American"][
    ...
    },
    {
      ...
      weeksvalue:
        props.twoweeksvac["nation"]["Asian"]["pctAmongFullyVasLast14"] < 0
          ? 0
    ...
    },
    {
      ...
      vaxvalue:
        props.fips == "_nation"
          ...
          : props.VaccineData[props.fips][0]["NHPI"][0]["percentVaccinated"],
      weeksvalue:
        props.twoweeksvac["nation"]["NHPI"]["pctAmongFullyVasLast14"] < 0
          ? 0
    ...
    if (active && payload && payload.length) {
      ...
      return (
        ...
        >
          ...
          <p>
            {" "}
            % Vaccination in past 14 days: {payload[0].payload.weeksvalue}{" "}
          </p>
        </div>
      );
    }
                ...
                content: (
                  ...
                  >
                    <ul>
                      ...
                      <li>
                        The graphic is based on data from{" "}
                        {props.twoweeksvac["nation"]["White"]["totalFull"]}{" "}
                        people who are fully vaccinated. Race/Ethnicity is
                        available for{" "}
                        {
                          props.twoweeksvac["nation"]["White"][
                            "raceAvailableFull"
                          ]
                        }{" "}
                        (
                        {
                          props.twoweeksvac["nation"]["White"][
                            "pctRaceAvailableFull"
                          ]
                        }
                        %) people fully vaccinated.
                      </li>
                      <li>
                        Each bar represents the cumulative percentage of people
                        who are fully vaccinated in the specified race/ethnicity
                        group. This is a measure of vaccination coverage by
                        race/ethnicity at the present time.
                        <br />
                      ...
                      <li>
                        If the bar for % vaccinated is shorter than the %
                        population bar, it implies that the proportion of fully
                        vaccinated people in that racial/ethnic group is lower
                        than would be expected based on the that racial/ethnic
                  ...
                  >
                    <ul>
                      ...
                      <li>
                        ...
                        people with at least one dose administered.
                        Race/Ethnicity is available for{" "}
                        {
                          props.twoweeksvac["nation"]["White"][
                            "raceAvailableAtleastOne"
                          ]
                        }{" "}
                        (
                        {
                          props.twoweeksvac["nation"]["White"][
                            "pctRaceAvailableAtleastOne"
                          ]
                        }
                        %) people with at least one dose administered.
                      </li>
                      <li>
                        Each bar represents the percentage of people who
                        initiated vaccination in last 14 days in the specified
                        race/ethnicity group. This is a measure of new
                        vaccination uptake in the past two weeks. <br />
                        e.g. White Americans make up{" "}
                        {props.twoweeksvac["nation"]["White"][
                          "pctAmongFullyVasLast14"
                        ] < 0
                        ...
                        % of people who initiated vaccination in the last 14
                        days.
                      </li>
                      <li>
                        If the bar for %vaccination last 14 days is shorter than
                        the % population bar, it implies that the proportion of
                        people who initiated vaccination in the last 14 days in
                        that racial/ethnic group is lower than would be expected
                        based on the that racial/ethnic group’s representation
                ...
                content: (
                  ...
                  >
                    <ul>
                      ...
                      <li>
                        Population estimates for all territories and
                        protectorates (excluding Puerto Rico) is from the 2020
                        US Census International Data Base
                      </li>
                      <li>
                        Each bar represents the percentage of the US population
                        that belongs to the specific race/ethnic group.
                      </li>
                    </ul>
                    <br />
                    {/* <b><em> {vaxVarMap["percentVaccinatedDose1"].name} </em></b> {vaxVarMap["percentVaccinatedDose1"].definition} <br/>
...
const USVaccineTrackerPilot = (props) => {
  ...
  const [ageVaccine, setAgeVaccine] = useState();
  ...
  const vaccineList = {
    PercentAdministeredPartial:
      "% of population partially vaccinated (one dose received)",
    Series_Complete_Pop_Pct:
      "% of population fully vaccinated (two doses received)",
  };
  ...
  useEffect(() => {
    ...
    fetch("/data/vaccineSeriesAge.json")
      .then((res) => res.json())
      .then((x) => {
        setAgeSeries(x);
      });
    fetch("/data/vaccineAge.json")
      .then((res) => res.json())
      .then((x) => {
        setAgeVaccine(x);
      });
  ...
  useEffect(() => {
    if (metric) {
      fetch("/data/VaccineTimeseries.json")
        .then((res) => res.json())
        .then((x) => {
          setVaxSeries(x);
        });
      fetch("/data/vaccLast14daysByRace.json")
        .then((res) => res.json())
        .then((x) => {
          setTwoweeksvac(x);
        });
  ...
  const labelAge = (d) => {
    ...
    if (d.datum.childName == "Age 5-12") {
      return (
        monthNames[new Date(d.datum.t * 1000).getMonth()] +
        " " +
        new Date(d.datum.t * 1000).getDate() +
        " " +
        new Date(d.datum.t * 1000).getFullYear() +
        "\n " +
        d.datum.childName +
        " : " +
        d.datum._y.toFixed(1)
      );
    }
    return (
      // <div className="custom-tooltip" style={{ lineHeight: "19px" }}>
      //   <p style={{ margin: 0 }} className="label">{`${(new Date(d.t * 1000).getMonth() + 1) + "/" + new Date(d.t * 1000).getDate() + "/" + new Date(d.t * 1000).getFullYear()}`}</p>
      ...
      //   <p style={{ margin: 0, color: colorPaletteGraph[0] }} className="intro">{`Percent Fully Vaccinated For Age 5-12: ${(d.datum.Series_Complete_5Plus).toFixed(1)}`}</p>
      //   <p style={{ margin: 0, color: colorPaletteGraph[4] }} className="intro">{`Percent Fully Vaccinated For Age 12-18: ${(d.datum.Series_Complete_12Plus).toFixed(1)}`}</p>
      //   <p style={{ margin: 0, color: colorPaletteGraph[0] }} className="intro">{`Percent Fully Vaccinated For Age 18-65: ${(d.datum.Series_Complete_18Plus).toFixed(1)}`}</p>
      //   <p style={{ margin: 0, color: colorPaletteGraph[4] }} className="intro">{`Percent Fully Vaccinated For Age 65+: ${(d.datum.Series_Complete_65Plus).toFixed(1)}`}</p>
  ...
  if (
    ...
    const description = {
      aa:
        ...
        vaccDisparityData["cutoffs"][0]["black"].toFixed(0) +
        " % of the population is African American. Counties are considered to have a low proportion of African Americans if less than " +
        vaccDisparityData["cutoffs"][0]["black"].toFixed(0) +
        " % of the population is African American.",
      hispanic:
        "The chart shows the average percentage of the population that has received at least one dose of the COVID-19 vaccine in the counties grouped by % of the population that is Hispanic. Counties are considered to have a high proportion of Hispanic Americans if more than " +
        vaccDisparityData["cutoffs"][0]["hispanic"].toFixed(0) +
        " % of the population is Hispanic. Counties are considered to have a low proportion of Hispanic Americans if less than " +
        vaccDisparityData["cutoffs"][0]["hispanic"].toFixed(0) +
        " % of the population is Hispanic.",
      age65:
        "The chart shows the average percentage of the population that has received at least one dose of the COVID-19 vaccine in the counties grouped by % of population aged 65+. Counties with a high proportion of the population aged over 65 are those with more than " +
        vaccDisparityData["cutoffs"][0]["age65over"].toFixed(0) +
        " % of the population of age over 65. Counties with a low proportion of the population aged 65 over have less than " +
        vaccDisparityData["cutoffs"][0]["age65over"].toFixed(0) +
        " % of their population over age 65.",
      condition:
        "The chart shows the average percentage of the population that has received at least one dose of the COVID-19 vaccine in the counties grouped by % of the population with at least one underlying condition. Counties with a high proportion of people with underlying conditions include those where more than " +
        vaccDisparityData["cutoffs"][0]["anycondition"].toFixed(0) +
        " % of the population have an underlying condition. Counties with a low proportion of people with underlying conditions are those where less than " +
        vaccDisparityData["cutoffs"][0]["anycondition"].toFixed(0) +
        " % of the population has an underlying condition.",
      poverty:
        "The chart shows the average percentage of the population that has received at least one dose of the COVID-19 vaccine in the counties grouped by % of the population living in poverty. Counties with a high proportion of population in poverty have more than " +
        vaccDisparityData["cutoffs"][0]["poverty"].toFixed(0) +
        " % of their population living in poverty. Counties with a low proportion in poverty are those where less than " +
        vaccDisparityData["cutoffs"][0]["poverty"].toFixed(0) +
        " % of the population lives in poverty,",
      minority:
        "The chart shows the average percentage of the population that has received at least one dose of the COVID-19 vaccine in the counties grouped by % minority population. Counties with a high proportion of minority have more than " +
        vaccDisparityData["cutoffs"][0]["minority"].toFixed(0) +
        " % of their populaiton which are racial and ethnic minorities. Counties with a low proportion of minorities have less than " +
        vaccDisparityData["cutoffs"][0]["minority"].toFixed(0) +
        " % minority population.",
      native:
        "The chart shows the average percentage of the population that has received at least one dose of the COVID-19 vaccine in the counties grouped by % of the population that is Native American. Counties are considered to have a high proportion of Native Americans if more than " +
        vaccDisparityData["cutoffs"][0]["natives"].toFixed(0) +
        " % of the population is Native American. Counties are considered to have a low proportion of Native Americans if less than " +
        vaccDisparityData["cutoffs"][0]["natives"].toFixed(0) +
        " % of the population is Native American.",
      uninsured:
        "The chart shows the average percentage of the population that has received at least one dose of the COVID-19 vaccine in the counties grouped by % uninsured population. Counties are considered to have a high proportion of uninsured population if they have more than " +
        vaccDisparityData["cutoffs"][0]["uninsured"].toFixed(0) +
        " % of their population uninsured. Counties are considered to have a low proportion of uninsured population if they have less than " +
        vaccDisparityData["cutoffs"][0]["uninsured"].toFixed(0) +
        " % uninsured population.",
      region:
        "The chart shows the average percentage of the population that has received at least one dose of the COVID-19 vaccine in different regions in the United States.",
      urbanrural:
        "The chart shows the average percentage of the population that has received at least one dose of the COVID-19 vaccine in the counties grouped by urbanicity. Inner city counties have > 1 million population or contain the entire or a large part of the population of the largest principal city. Large suburban counties have a population > 1 million, but do not qualify as inner city. Small suburban counties have a population of 250,000-999,999. Small cities have populations < 250,000 and are near large cities. Rural areas near cities have an urbanized area with population between 10,000-49,999. Remote rural counties have populations less than 10,000 individuals. This urban-rural classification scheme is from the National Center for Health Statistics. (https://www.cdc.gov/nchs/data_access/urban_rural.htm)",
      college:
        "The chart shows the average percentage of the population that has received at least one dose of the COVID-19 vaccine in the counties grouped by % college education. Counties with a high proportion of educated population are those where more than " +
        vaccDisparityData["cutoffs"][0]["college"].toFixed(0) +
        " % are college educated. Counties with a low proportion of college educated population are those where less than " +
        vaccDisparityData["cutoffs"][0]["college"].toFixed(0) +
            ...
            <Grid>
              ...
              <Grid.Column style={{ paddingLeft: 170, width: 1000 }}>
                ...
                <Grid>
                  <Grid.Row
                    columns={5}
                    style={{ width: 1000, paddingLeft: 35, paddingTop: 40 }}
                  >
                    <Grid.Column
                      style={{
                        width: 240,
                    ...
                    <Grid.Column
                      style={{ width: 240, paddingLeft: 85, paddingTop: 8 }}
                    >
                      <center
                        style={{
                          width: 240,
                    ...
                    <Grid.Column
                      style={{ width: 240, paddingLeft: 170, paddingTop: 8 }}
                    >
                      <center
                        style={{
                          width: 240,
                    ...
                    <Grid.Column
                      style={{ width: 240, paddingLeft: 232, paddingTop: 8 }}
                    >
                      <center
                        style={{
                          width: 240,
                  ...
                  <Grid.Row
                    columns={5}
                    style={{ width: 1000, paddingLeft: 35, paddingTop: 0 }}
                  >
                    <Grid.Column
                      style={{ width: 240, paddingLeft: 0, paddingTop: 0 }}
                    >
                      <div
                        style={{
                          width: 240,
                    ...
                    <Grid.Column
                      style={{ width: 240, paddingLeft: 85, paddingTop: 0 }}
                    >
                      <div
                        style={{
                          width: 240,
                    ...
                    <Grid.Column
                      style={{ width: 240, paddingLeft: 170, paddingTop: 0 }}
                    >
                      <div
                        style={{
                          width: 240,
                    ...
                    <Grid.Column
                      style={{ width: 240, paddingLeft: 232, paddingTop: 0 }}
                    >
                      <div
                        style={{
                          width: 240,
                      ...
                      >
                        <Header style={{ textAlign: "center" }}>
                          ...
                          <Header.Content style={{ paddingBottom: 5 }}>
                            ...
                            >
                              {numberWithCommas(
                                vaccineData["_nation"]["Series_Complete_Yes"]
                              )}
                            </p>
                            <br />
                          </Header.Content>
                  ...
                  <Grid.Row>
                    <Grid.Column
                      style={{ width: 900, paddingLeft: 35, paddingTop: 18 }}
                    >
                      <div style={{ width: 900 }}>
                        <Header>
                          <div>
                ...
                <Grid>
                  ...
                  <Grid.Row
                    columns={1}
                    style={{ width: 1000, paddingTop: 0, paddingBottom: 15 }}
                  >
                    {/* <center> */}
                    <Grid.Column style={{ width: 850, paddingLeft: 60 }}>
                      <div style={{ paddingTop: "0em" }}>
                        ...
                        >
                          {" "}
                          Comparing the racial and ethnic breakdown of all
                          vaccinated individuals, recently vaccinated
                          individuals, and the total US population can help
                          identify groups that require addition efforts to
                          achieve full vaccination coverage. <br />
                        </Header.Subheader>
                      </div>
                    </Grid.Column>
                    {/* </center> */}
                          ...
                          <p style={{ fontSize: "18px", paddingLeft: 30 }}>
                            <ul>
                              ...
                              <li>
                                ...
                                % of those fully vaccinated,{" "}
                                {twoweeksvac["nation"]["African American"][
                                  "pctAmongFullyVasLast14"
                                ] < 0
                                  ? 0
                                  : twoweeksvac["nation"]["African American"][
                          ...
                          content: {
                            content: (
                              ...
                              >
                                ...
                                vaccination across non-Hispanic race categories.
                                Race & ethnicity was known for{" "}
                                {nationalDemog["vaccineRace"][0]["Unknown"][0][
                                  "seriesCompletePopPctUs"
                                ].toFixed(0) + "%"}{" "}
                                of fully vaccinated adults.
                                <br />
                                The CDC notes that “These demographic data only
                                represent the geographic areas that contributed
                                data and might differ by populations prioritized
                                within each state or jurisdiction’s vaccination
                                phase. Every geographic area has a different
                                racial and ethnic composition, and not all are
                                in the same vaccination phase.” For comparison
                                ...
                                are not represented in the vaccination data. The
                                numbers are therefore our best estimation of
                                vaccination coverage by race.
                              </Header.Content>
                            ),
                          },
                        },
                      ...
                      <AppBarMU position="static" style={{ width: 1010 }}>
                        ...
                        >
                          <TabMU
                            ...
                            label="State Vaccination By Age"
                            {...a11yProps(4)}
                          />
                          <TabMU
                            style={{
                        ...
                        <Grid.Row columns={2} style={{ width: 1260 }}>
                          <Grid.Column style={{ width: 1000, paddingLeft: 0 }}>
                            <div style={{ paddingBottom: 0, width: 1000 }}>
                              <Header.Content
                                style={{ paddingLeft: 20, fontSize: "22px" }}
                              >
                                          ...
                                          content: (
                                            ...
                                            >
                                              ...
                                              <b>
                                                <em>
                                                  {" "}
                                                  Newly distributed per 100K{" "}
                                                </em>
                                              </b>{" "}
                                              is the number of vaccine doses per
                                              100K that have been distributed to
                                              facilities across the United
                                              States by the federal government.
                                              Newly distributed per 100K for the
                                              U.S. was data as of {vaccineDate}.
                                              For{" "}
                                              {stateName === "_nation"
                                                ? "SELECT STATE"
                                                : stateName}
                                              , the most recent date of new
                                              distribution was on {vaccineDate}.{" "}
                                              <br />
                                            </Header.Content>
                                          ),
                                        },
                                ...
                                <Table.Row textAlign = 'center'>
                                  ...
                                  <Table.HeaderCell style={{fontSize: '19px'}}> {numberWithCommas(vaccineData[stateMapFips]["Administered_Pfizer"])} </Table.HeaderCell>
                                    ...
                                    <Table.Row textAlign="center">
                                      ...
                                      >
                                        {" "}
                                        {vaccineData[stateMapFips]["Dist_new"]
                                          ? numberWithCommas(
                                              vaccineData["_nation"][
                                                "Dist_new"
                                              ].toFixed(0)
                          ...
                          <VictoryLegend
                            ...
                            data={
                              activity
                                ...
                                : trendStateName === "The United States"
                                ? [
                                    {
                                      name: "National Average",
                                      symbol: { fill: "black", type: "square" },
...
<Header.Content style={{ paddingLeft: 50, width: 450 }}>
                        ...
                        <Grid.Row columns={2} style={{ width: 1100 }}>
                          <Grid.Column>
                            ...
                            >
                              ...
                              <br></br>
                              <b>
                                by age as Of {vaccineDate} in {trendStateName}
                              </b>
                            </Header.Content>
                                    ...
                                    data={[
                                      {
                                        key: "5-12",
                                        value:
                                          stateTrendFips == "_nation"
                                            ? ageVaccine["_nation"][
                                                "Series_Complete_5PlusPop_Pct"
                                              ]
                                            : ageVaccine[stateTrendFips][
                                                "Series_Complete_5PlusPop_Pct"
                                              ],
                                      },
                                      {
                                        ...
                                        >
                                          <ul>
                                            ...
                                            <li>
                                              ...
                                              (all doses in the primary series)
                                              in the specified age group as of{" "}
                                              {vaccineDate}.
                                            </li>
                                          </ul>
                                          <br />
      ...
      <b><em> {vaxVarMap["Series_Complete_Pop_Pct"].name} </em></b> {vaxVarMap["Series_Complete_Pop_Pct"].definition} <br/> */}
                          ...
                          <Grid.Column style={{ width: 1000, paddingLeft: 0 }}>
                            ...
                            >
                              <b>
                                Trends in Vaccination by Age in {trendStateName}
                              </b>
                              <br></br>
                              <br></br>
                            </Header.Content>
                                      ...
                                      content: (
                                        ...
                                        >
                                          <ul>
                                            ...
                                            <li>
                                              Each line shows the percentage of
                                              people in {trendStateName} who are
                                              fully vaccinated (all doses in the
                                              primary series) in the specified
                                              age group over time.
                                            </li>
                                          </ul>
                                          <br />
      ...
      <b><em> {vaxVarMap["Series_Complete_Pop_Pct"].name} </em></b> {vaxVarMap["Series_Complete_Pop_Pct"].definition} <br/> */}
                  ...
                  <div className={classes.root} style={{ paddingLeft: 0 }}>
                      ...
                      <AppBarMU position="static" style={{ width: 1010 }}>
                        ...
                        >
                          <TabMU
                            ...
                            label="County Vaccination Trends"
                            {...a11yProps(0)}
                          />
                          <TabMU
                            style={{
                    ...
                    <TabPanel value={value2} index={0}>
                      ...
                      <Grid.Row
                        style={{ paddingLeft: "4.9em", paddingRight: "2em" }}
                      >
                        <Accordion
                          defaultActiveIndex={1}
                          panels={[
                            {
                              ...
                              content: {
                                content: (
                                  <p
                                    style={{ fontFamily: "lato", fontSize: 18 }}
                                  >
                  ...
                  <Grid.Row columns={2} style={{ width: 1000 }}>
                    <Grid.Column style={{ width: 630 }}>
                      <Grid>
                        <Grid.Row
                          columns={2}
                          style={{ width: 630, paddingLeft: 20 }}
                        >
                              ...
                              panels={[
                                {
                                  ...
                                  content: {
                                    content: (
                                      ...
                                      >
                                        *14-day change trends use 7-day
                                        averages.
                                        <br />
                                        <b>
                                          <em> {varMap["dailycases"].name} </em>
                                        </b>{" "}
                                        {varMap["dailycases"].definition}
                                        <br />
                                        <b>
                                          <em>
                                            {" "}
                                            {varMap["dailydeaths"].name}{" "}
                                          </em>
                                        </b>{" "}
                                        {varMap["dailydeaths"].definition}
                                        <br />
                                        <br />
                                      </Header.Content>
                                    ),
                        ...
                        <Grid.Row>
                          <Grid.Column
                            style={{ paddingLeft: 20, paddingTop: 101 }}
                          >
                            <Header
                              as="h2"
                              ...
                              <Grid.Row columns={1}>
                                ...
                                >
                                  <div style={{ marginTop: 50 }}>
                                    ...
                                    >
                                      {" "}
                                      Deaths per capita by Race & Ethnicity{" "}
                                      <br /> <br /> <br /> <br />{" "}
                                    </text>
                                    <text
                                      style={{
                                                ...
                                                stateMapFips === "_nation" && (
                                                  ...
                                                  >
                                                    ...
                                                    >
                                                      ...
                                                      deaths by combined race
                                                      and ethnicity groups. The
                                                      chart shows race and
                                                      ethnicity groups that
                                                      constitute at least 1% of
                                                      the state population and
                                                      have 30 or more deaths.
                    ...
                    <Grid.Column style={{ paddingLeft: 80, width: 630 }}>
                      <div style={{ paddingTop: 10, paddingLeft: 50 }}>
                        ...
                        <svg width="500" height="40">
                          ...
                          />
                          <text x={35} y={20} style={{ fontSize: "22px" }}>
                            {" "}
                            USA
                          </text>
                          <rect
                      ...
                      <Grid>
                        <Grid.Row>
                          {stateFips && (
                            <Accordion
                              style={{ paddingTop: 85, paddingLeft: 32 }}
                              defaultActiveIndex={1}
                              panels={[
                                {
                                  key: "acquire-dog",
                                      ...
                                      >
                                        <b>
                                          <em>
                                            {" "}
                                            {
                                              varMap["caserate7dayfig"].name
                                            }{" "}
                                          </em>
                                        </b>{" "}
                                        {varMap["caserate7dayfig"].definition}
                                        <br />
                                        <b>
                                          <em>
                                            {" "}
                                            {
                                              varMap["covidmortality7dayfig"]
                                                .name
                                            }{" "}
                                          </em>
                                        </b>{" "}
              ...
              <Table celled inverted selectable>
                <Table.Body>
                  <Table.Row style={{ height: 25 }}>
                    ...
                    >
                      {" "}
                      % that have received at least one does
                    </Table.HeaderCell>
                    <Table.HeaderCell
                      style={{
                        fontSize: "16px",
                    ...
                    >
                      {numberWithCommas(
                        vaccineData[fips]["percentVaccinatedDose1"]
                      ) + "%"}
                    </Table.HeaderCell>
                  </Table.Row>
                  ...
                  <Table.Row style={{ height: 25 }}>
                    ...
                    >
                      {numberWithCommas(
                        vaccineData[fips]["Series_Complete_Pop_Pct"]
                      ) + "%"}
                    </Table.HeaderCell>
                  </Table.Row>
                </Table.Body>
            ...
            <ReactTooltip offset={{ top: 40 }}>
              <div>
                ...
                <Table celled inverted selectable compact>
                  <Table.Body>
                    <Table.Row style={{ height: 25 }}>
                      <Table.HeaderCell style={{ fontSize: "16px" }}>
                        {" "}
                        All ages
                      </Table.HeaderCell>
                      <Table.HeaderCell
                      ...
                      >
                        {countyMapGeoFips &&
                          numberWithCommas(
                            data[countyMapGeoFips]["seriesCompletePopPct"] ===
                              -1
                              ? "NA"
                              : data[countyMapGeoFips]["seriesCompletePopPct"]
                          ) + "%"}
