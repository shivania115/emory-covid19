                  ...
                  <Grid style = {{width: 1260}}>
                    <Grid.Row columns = {2} style = {{width: 1260}}>
                      <Grid.Column style = {{width: 550, paddingLeft: 0}}>
                        ...
                        <div style = {{paddingBottom: 0, width: 550}}>
                      ...
                      <Grid.Column style ={{paddingLeft: -20, width: 300}}>
                        <AppBarMU position="static">
                            ...
                            classes={{
                              ...
                              indicator: classes.customTabIndicator}}
                            >
                              <TabMU style = {{textTransform: "capitalize", fontSize: "19px"}} label="Vaccination Status" {...a11yProps(3)} />
                              <TabMU style = {{textTransform: "capitalize", fontSize: "19px"}} label="Vaccination By Race" {...a11yProps(4)} />
                              {/* <TabMU style = {{textTransform: "capitalize", fontSize: "19px"}} label="Item Three" {...a11yProps(2)} /> */}
                          </TabsMU>
                        </AppBarMU>
                        ...
                        <Header as='h2' style={{fontWeight: 400}}>
                          <Header.Content style={{width : 300, height: 100, fontSize: "22px", textAlign: "center", paddingTop: 45, paddingLeft: 0}}>
                        ...
                        <Grid>
                          <Grid.Row style={{width: 400, paddingLeft: 0, paddingTop: 30}}>
                            <Table celled fixed style = {{width: 400}}>
                              <Table.Header>
                                ...
                                <tr textalign = "center" colSpan = "5" style = {{backgroundImage : 'url(/Emory_COVID_header_LightBlue.jpg)'}}>
                                    ...
                                    <td colSpan='1' style={{width:125, fontSize: '14px', textAlign : "center", font: "lato", fontWeight: 600, color: "#FFFFFF"}}> {stateMapFips === "_nation" ? "Select State":usAbbrev[stateMapFips]["state_abbr"]}</td>
                                    <td colSpan='1' style={{width:125, fontSize: '14px', textAlign : "center", font: "lato", fontWeight: 600, color: "#FFFFFF"}}> U.S.</td>
                                </tr>
