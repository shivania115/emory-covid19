                      ...
                      <Grid.Column style={{ width: 1000, paddingLeft: 30 }}>
                        <div style={{ paddingBottom: 0, width: 1000 }}>
                          ...
                          <svg width="460" height="80">
                            ...
                            <text x={20} y={35} style={{ fontSize: "0.7em" }}>
                              {legendMin + "%"}
                            </text>
                            <text x={140} y={35} style={{ fontSize: "0.7em" }}>
                              {legendMax + "%"}
                            </text>
                            ...
                            <text x={20} y={74} style={{ fontSize: "0.8em" }}>
                              Low
                            </text>
                            <text
                              ...
                              <svg>
                                ...
                                {geographies.map((geo) => (
                                  <Geography
                                    ...
                                    fill={
                                      stateMapFips === geo.id.substring(0, 2) ||
                        ...
                        <Grid>
                          <Grid.Row>
                            {stateFips && (
                              <Accordion
                                id="burden"
                                style={{ paddingTop: 10, paddingLeft: 14 }}
                                defaultActiveIndex={1}
                                panels={[
                                  {
                                    key: "acquire-dog",
                                    ...
                                    content: {
                                      content: (
                                        ...
                                        >
                                          ...
                                          {
                                            vaxVarMap["Series_Complete_Pop_Pct"]
                                              .definition
                                          }{" "}
                                          <br />
                                          <b>
                                          ...
                                          facilities across the United States by
                                          the federal government. Newly
                                          distributed per 100K for the U.S. was
                                          data as of {vaccineDate}. For{" "}
                                          {stateName === "_nation"
                                            ? "SELECT STATE"
                                            : stateName}
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    {stateMapFips === "_nation"
                                      ? "Select State"
                                      : usAbbrev[stateMapFips]["state_abbr"]}
                                  </td>
                                  <td
                                    colSpan="1"
                                    style={{
            ...
            <table class="ui celled inverted table">
              <thead>
                <tr>
                  ...
                  <th>
                    {numberWithCommas(vaccineData[fips]["AdministeredPartial"])}
                  </th>
                </tr>
                <tr>
                  <th> % partially vaccinated</th>
                ...
                <tr>
                  ...
                  <th>
                    {numberWithCommas(vaccineData[fips]["Series_Complete_Yes"])}
                  </th>
                </tr>
                <tr>
                  <th> % fully vaccinated</th>
