    ...
    <Segment inverted>
      <Menu secondary inverted fixed='top'
        ...
        <Container style={{width: '1305px'}}>
          ...
          <Menu.Item style = {{paddingLeft: 15,paddingRight: 15,border:'5px solid rgba(0, 0, 0, 0.05)',}}
          ...
          <Menu.Item style = {{paddingLeft: 15, paddingRight: 15,border:'4px solid rgba(0, 0, 0, 0.05)'}}
