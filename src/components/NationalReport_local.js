          ...
          <Sticky offset={180} position="fixed" context={contextRef}>
            <Menu size="small" compact pointing secondary vertical>
              <Menu.Item
                as="a"
                href="#"
                name="COVID-19 National Health Equity Report"
                active={
                  props.activeCharacter ==
                    "COVID-19 National Health Equity Report" ||
                  activeItem === "COVID-19 National Health Equity Report"
                }
                onClick={(e, { name }) => {
                  setsTate({ activeItem: name });
                }}
              >
                <Header as="h4">COVID-19 National Health Equity Report</Header>
              </Menu.Item>
              <Menu.Item
                as="a"
                href="#cases"
                name="Cases in the U.S. Over Time"
                active={
                  props.activeCharacter == "Cases in the U.S. Over Time" ||
                  activeItem === "Cases in the U.S. Over Time"
                }
                onClick={(e, { name }) => {
                  setsTate({ activeItem: name });
                }}
              >
                <Header as="h4">Cases in the U.S. Over Time</Header>
              </Menu.Item>
              <Menu.Item
                as="a"
                href="#deaths"
                name="Deaths in the U.S. Over Time"
                active={
                  props.activeCharacter == "Deaths in the U.S. Over Time" ||
                  activeItem === "Deaths in the U.S. Over Time"
                }
                onClick={(e, { name }) => {
                  setsTate({ activeItem: name });
                }}
              >
                <Header as="h4">Deaths in the U.S. Over Time</Header>
              </Menu.Item>
              <Menu.Item
                as="a"
                href="#half"
                name="50% of Cases Comes From These States"
                active={
                  props.activeCharacter ==
                    "50% of Cases Comes From These States" ||
                  activeItem === "50% of Cases Comes From These States"
                }
                onClick={(e, { name }) => {
                  setsTate({ activeItem: name });
                }}
              >
                <Header as="h4">50% of Cases Comes From These States</Header>
              </Menu.Item>
              <Menu.Item
                as="a"
                href="#commu"
                name="COVID-19 Across U.S. Communities"
                active={
                  props.activeCharacter == "COVID-19 Across U.S. Communities" ||
                  activeItem === "COVID-19 Across U.S. Communities"
                }
                onClick={(e, { name }) => {
                  setsTate({ activeItem: name });
                }}
              >
                <Header as="h4">COVID-19 Across U.S. Communities</Header>
              </Menu.Item>
              <Menu.Item
                as="a"
                href="#ccvi"
                name="COVID-19 by Community Vulnerability Index"
                active={
                  props.activeCharacter ==
                    "COVID-19 by Community Vulnerability Index" ||
                  activeItem === "COVID-19 by Community Vulnerability Index"
                }
                onClick={(e, { name }) => {
                  setsTate({ activeItem: name });
                }}
              ...
              <Menu.Item
                as="a"
                href="#poverty"
                name="COVID-19 by Percent in Poverty"
                active={
                  props.activeCharacter == "COVID-19 by Percent in Poverty" ||
                  activeItem === "COVID-19 by Percent in Poverty"
                }
                onClick={(e, { name }) => {
                  setsTate({ activeItem: name });
                }}
              ...
              <Menu.Item
                as="a"
                href="#metro"
                name="COVID-19 by Metropolitan Status"
                active={
                  props.activeCharacter == "COVID-19 by Metropolitan Status" ||
                  activeItem === "COVID-19 by Metropolitan Status"
                }
                onClick={(e, { name }) => {
                  setsTate({ activeItem: name });
                }}
              ...
              <Menu.Item
                as="a"
                href="#region"
                name="COVID-19 by Region"
                active={
                  props.activeCharacter == "COVID-19 by Region" ||
                  activeItem === "COVID-19 by Region"
                }
                onClick={(e, { name }) => {
                  setsTate({ activeItem: name });
                }}
              ...
              <Menu.Item
                as="a"
                href="#black"
                name="COVID-19 by Percent African American"
                active={
                  props.activeCharacter ==
                    "COVID-19 by Percent African American" ||
                  activeItem === "COVID-19 by Percent African American"
                }
                onClick={(e, { name }) => {
                  setsTate({ activeItem: name });
                }}
              ...
              <Menu.Item
                as="a"
                href="#resseg"
                name="COVID-19 by Residential Segregation Index"
                active={
                  props.activeCharacter ==
                    "COVID-19 by Residential Segregation Index" ||
                  activeItem === "COVID-19 by Residential Segregation Index"
                }
                onClick={(e, { name }) => {
                  setsTate({ activeItem: name });
                }}
              ...
              <Menu.Item
                as="a"
                href="#comorb"
                name="COVID-19 by Underlying Comorbidity"
                active={
                  props.activeCharacter ==
                    "COVID-19 by Underlying Comorbidity" ||
                  activeItem === "COVID-19 by Underlying Comorbidity"
                }
                onClick={(e, { name }) => {
                  setsTate({ activeItem: name });
                }}
...
function CaseSection(props) {
  ...
  return (
    <Grid.Row
      style={{ paddingLeft: "3rem", paddingBottom: "0rem", height: "39rem" }}
    >
      <Grid.Column style={{ paddingTop: "1rem", paddingLeft: "22rem" }}>
        <Menu pointing secondary widths={3} style={{ width: "16rem" }}>
          ...
          <Menu.Item
            name="90 Days"
            active={activeItem === "90 Days"}
            onClick={() => setActiveItem("90 Days")}
          />
          <Menu.Item
            name="14 Days"
            active={activeItem === "14 Days"}
            onClick={() => setActiveItem("14 Days")}
          />
        </Menu>
      </Grid.Column>
...
function CaseChartAll(props) {
  ...
  return (
    <Grid.Column
      style={{ paddingTop: 20, paddingleft: "5rem", width: 850, height: 500 }}
    >
      <ComposedChart
        width={830}
        height={420}
      ...
      >
        ...
        <Bar
          ...
          onAnimationEnd={() => {
            ...
            setTimeout(
              () =>
                setHighlightIndex((highlightIndex) => [...highlightIndex, 71]),
              wait + 2000
            );
            setTimeout(() => setVisible4(true), wait + 3000);
            setTimeout(
              () =>
                setHighlightIndex((highlightIndex) => [...highlightIndex, 109]),
              wait + 3000
            );
            setTimeout(() => setVisible5(true), wait + 4000);
            setTimeout(
              () =>
                setHighlightIndex((highlightIndex) => [...highlightIndex, 260]),
              wait + 4000
            );
      ...
      <Transition visible={visible1} animation="scale" duration={300}>
        ...
        >
          {" "}
          Jan. 21: <br /> 1st case in the U.S. confirmed in Washington
        </Message>
      </Transition>
      <Transition visible={visible2} animation="scale" duration={300}>
        ...
        >
          {" "}
          Apr. 10: <br /> First wave peaked at 31,709 new cases <br />
          (7-day avg.){" "}
        </Message>
      </Transition>
      <Transition visible={visible3} animation="scale" duration={300}>
        ...
        >
          {" "}
          June. 11: <br /> 2M confirmed cases in the U.S.{" "}
        </Message>
      </Transition>
      <Transition visible={visible4} animation="scale" duration={300}>
        ...
        >
          {" "}
          July. 19: <br /> Second wave peaked at 66,692 new cases <br />
          (7-day avg.){" "}
        </Message>
      </Transition>
      <Transition visible={visible5} animation="scale" duration={300}>
        ...
        >
          {" "}
          Dec. 17: <br /> Third wave peaked at 222,822 new cases <br />
          (7-day avg.){" "}
        </Message>
      </Transition>
    ...
    >
      ...
      >
        ...
        <XAxis
          dataKey="t"
          type="number"
          domain={[data[data.length - 91].t, "dataMax"]}
    ...
    >
      ...
      >
        ...
        <XAxis
          dataKey="t"
          type="number"
          domain={[data[data.length - 15].t, "dataMax"]}
  ...
  return (
    <Grid.Column style={{ paddingTop: 28, width: 850, height: 500 }}>
      ...
      <Transition visible={visible2} animation="scale" duration={300}>
        ...
        >
          {" "}
          May. 27: <br /> Coronavirus deaths in the U.S. passed 100,000{" "}
        </Message>
      </Transition>
      <Transition visible={visible3} animation="scale" duration={300}>
        <Message
        ...
        >
          {" "}
          Sep. 22: <br /> Coronavirus deaths in the U.S. passed 200,000{" "}
        </Message>
      </Transition>
      {/* <Transition visible={visible4} animation='scale' duration={300}>
              ...
              <Grid.Column width={14}>
                ...
                >
                  ...
                  >
                    ...
                    time, geography, and demography. The report will be released
                    each week to keep track of how COVID-19 is impacting U.S.
                    communities.
                  </Header.Content>
                </div>
                <div id="cases" style={{ height: 45 }}>
                  {" "}
                </div>
                              ...
                              content: (
                                ...
                                >
                                  <Header.Content style={{ fontSize: "14pt" }}>
                                    ...
                                    >
                                      This figure shows the trend of daily
                                      COVID-19 deaths in U.S.. The bar height
                                      reflects the number of new deaths per day
                                      and the line depicts 7-day moving average
                                      of daily deaths in U.S.. There were{" "}
                                      {dailyDeaths} new deaths associated with
                                      COVID-19 reported on{" "}
                                      {monthNames[
                                        new Date(
                                          dataTS["_nation"][
                                            dataTS["_nation"].length - 1
                                          ].t * 1000
                                        ).getMonth()
                                      ] +
                                        " " +
                                      ...
                                      , with an average of {mortalityMean} new
                                      deaths per day reported over the past 7
                                      days. We see{" "}
                                      ...
                                      in the average new deaths over the past
                                      14-day period.
                                      <br />
                                      <br />
                ...
                >
                  ...
                  >
                    <Header.Content>
                      ...
                      >
                        Cases and deaths attributed to COVID-19 are rapidly
                        rising in some counties. Additionally, the geographic
                        distribution of the hardest-hit counties is changing,
                        with the virus shifting from the Northeast toward the
                        Southeast and Southwest. Approximately 50% of new cases
                        on{" "}
                        {monthNames[
                          new Date(
                            dataTS["_nation"][dataTS["_nation"].length - 1].t *
                    ...
                    <Header.Content>
                      ...
                      >
                        <center>
                          {" "}
                          <b style={{ fontSize: "18pt" }}>
                            Cases and deaths by race, age, and sex{" "}
                          </b>{" "}
                        </center>
                        <br />
                        <br />
                        While people of all races, ages, and sex are impacted by
                        COVID-19, some subgroups are disproportionally affected.{" "}
                        {Object.keys(demog_descriptives["Race"][0])[0]} are
                        seeing the largest mortality rate, with{" "}
                        {demog_descriptives["Race"][0][
                          Object.keys(demog_descriptives["Race"][0])[0]
                        ].toFixed(0)}{" "}
                        cases per 100,000 individuals, around{" "}
                        {(
                          demog_descriptives["Race"][0][
                            Object.keys(demog_descriptives["Race"][0])[0]
                          ] /
                          demog_descriptives["Race"][0][
                            Object.keys(demog_descriptives["Race"][0])[1]
                          ]
                        ).toFixed(0)}{" "}
                        times that of{" "}
                        {Object.keys(demog_descriptives["Race"][0])[1]}, the
                        groups with the lowest mortality rate. Deaths are
                        highest in the{" "}
                        {Object.keys(demog_descriptives["Age"][0])[0]} age group
                        (
                        {demog_descriptives["Age"][0][
                          Object.keys(demog_descriptives["Age"][0])[0]
                        ].toFixed(0)}{" "}
                        deaths per 100,000), followed by{" "}
                        {Object.keys(demog_descriptives["Age"][0])[1]} age group
                        (
                        {demog_descriptives["Age"][0][
                          Object.keys(demog_descriptives["Age"][0])[1]
                        ].toFixed(0)}{" "}
                        deaths per 100,000). Those{" "}
                        {Object.keys(demog_descriptives["Age"][0])[3] ===
                          "0 - 4" &&
                        Object.keys(demog_descriptives["Age"][0])[2] ===
                          "5 - 17"
                          ? " under 18 "
                          : "in " +
                            (Object.keys(demog_descriptives["Age"][0])[3] +
                              ...
                              Object.keys(demog_descriptives["Age"][0])[2] +
                              " age group ")}{" "}
                        are, however, experiencing the lowest mortality from
                        COVID-19.
                      </Header.Subheader>
                    </Header.Content>
                  </Header>
                ...
                <Grid>
                  ...
                  <Grid.Row
                    style={{ width: 1000, paddingLeft: 300, paddingTop: "1em" }}
                  >
                  ...
                  <Grid.Row columns={2} style={{ width: 1000 }}>
                    <Grid.Column style={{ width: 450, paddingLeft: 300 }}>
                      ...
                      >
                        <center>
                          {" "}
                          <b style={{ fontSize: "18pt" }}>Cases by Age</b>{" "}
                        </center>
                        <br />
                        <br />
                      </Header.Subheader>
                    ...
                    <Grid.Column style={{ width: 450, paddingLeft: 145 }}>
                      ...
                      >
                        <center>
                          {" "}
                          <b style={{ fontSize: "18pt" }}>Deaths by Age</b>{" "}
                        </center>
                        <br />
                        <br />
                      </Header.Subheader>
                          ...
                          <VictoryGroup offset={23}>
                            <VictoryBar
                              ...
                              data={[
                                ...
                                {
                                  key: nationalDemog["Age"][0]["5 - 17"][0][
                                    "demogLabel"
                                  ],
                                  value:
                                    nationalDemog["Age"][0]["5 - 17"][0][
                                      "percentCases"
                                    ],
                                },
                                {
                ...
                <div id="commu" style={{ height: 45 }}>
                  {" "}
                </div>

                <center style={{ paddingLeft: 190 }}>
                  {" "}
                  <Divider style={{ width: 900, paddingTop: 40 }} />{" "}
                </center>
                {true && (
                      ...
                      >
                        ...
                        >
                          <center>
                            {" "}
                            <b style={{ fontSize: "18pt" }}>
                              COVID-19 cases per 100,000 across the population
                              characteristics of all the counties in the United
                              States{" "}
                            </b>{" "}
                          </center>
                          <br />
                          ...
                          socioeconomic status, race, and underlying medication
                      ...
                      <Grid>
                        <Grid.Row columns={2} style={{ paddingTop: 8 }}>
                          ...
                          >
                                ...
                                {_.map(legendSplitMetric, (splitpoint, i) => {
                                  if (legendSplitMetric[i] < 1) {
                                    ...
                                    return (
                                      ...
                                      >
                                        {" "}
                                        {(legendSplitMetric[i] / 1000).toFixed(
                                          0
                                        ) + "K"}
                                      </text>
                                    );
                            ...
                            <Accordion
                              style={{ paddingTop: 150, paddingLeft: 100 }}
                              defaultActiveIndex={1}
                              panels={[
                                {
                                  key: "acquire-dog",
                                      ...
                                      >
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            COVID-19 cases (top chart) and
                                            deaths (bottom chart) per 100,000
                                            residents by CCVI ranking. The
                                            y-axis displays CCVI rankings based
                                            on quintiles (groups of 20%). The
                                            ...
                                            designed to be of equal size, so
                                            that the lowest quintile contains
                                            the counties with values in the
                                            0%-20% range for this county
                                            characteristic, and the highest
                                            quintile contains counties with
                                            values in the 80%-100% range for
                                            this county characteristic. Q2
                                            indicates counties in the 20%-40%
                                            range, Q3 indicates counties in the
                                            40%-60% range, and Q4 indicates
                          ...
                          <Grid.Column>
                            ...
                            >
                              ...
                              <VictoryBar
                                ...
                                data={[
                                  {
                                    key: nationalBarChart["caserate7day"][0][
                                      metric === "ccvi" ? "CVI" : metric
                                    ][0]["label"],
                                    value:
                                      (nationalBarChart["caserate7day"][0][
                                        metric === "ccvi" ? "CVI" : metric
                                      ][0]["measure"] /
                                        nationalBarChart["caserate7day"][0][
                                          metric === "ccvi" ? "CVI" : metric
                            ...
                            >
                              ...
                              <VictoryBar
                                ...
                                data={[
                                  {
                                    key: nationalBarChart[
                                      "covidmortality7day"
                                    ][0][metric === "ccvi" ? "CVI" : metric][0][
                                      "label"
                                    ],
                                    value:
                                      (nationalBarChart[
