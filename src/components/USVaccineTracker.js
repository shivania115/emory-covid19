...
const USVaccineTracker = (props) => {
  ...
  if (data && allTS && vaccineData && fips && dataTS && stateMapFips && VaxSeries) {
    ...
    const description = {
      ...
      "native": "The chart shows the average percentage of the population that has received at least one dose of the COVID-19 vaccine in the counties grouped by % of the population that is Native American. Counties are considered to have a high proportion of Native American if more than "+vaccDisparityData['cutoffs'][0]['natives'].toFixed(0)+" % of the population is Native American. Counties are considered to have a low proportion of Native Americans if less than "+vaccDisparityData['cutoffs'][0]['natives'].toFixed(0)+" % of the population is Native American.",
