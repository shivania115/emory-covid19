...
export default function MapState() {
      ...
      .then((x) => {
        ...
        setMeasureOptionsB(
          _.filter(
            ...
            (d) =>
              (d.text !== "region" &&
                d.text !== "Any Condition Prevalence2" &&
                d.text !== "Diabetes Prevalence" &&
                d.text !== "Heart Disease" &&
                d.text !== "Chronic Obstructive Pulmonary Disease" &&
                d.text !== "Chronic Kidney Disease" &&
                d.text !== "Urban-Rural Status Name" &&
                d.text !== "Region Status Code" &&
                (d.group === "exposure" || d.group === "misc") &&
                d.group !== "text" &&
                d.group !== "other") ||
              d.text === "Percent of population fully vaccinated" ||
              d.text === "Number fully vaccinated" ||
              d.text === "Percent of population 18+ fully vaccinated" ||
              d.text === "Percent of population 65+ fully vaccinated"
          )
        );
      });
  }, []);
  ...
  useEffect(() => {
    ...
    if (varMap && stateFips !== "_nation") {
      let coldata = {};
      const dataFltrd = _.filter(
        _.map(oriData, (d, k) => {
          d.fips = k;
          return d;
        }),
        (d) => d.fips.length === 5 && d.fips.substring(0, 2) === stateFips
      );
      _.each(dataFltrd, (d) => {
        _.each(d, (v, k) => {
          if (varMap[k]) {
      ...
      <HEProvider>
        <div>
          ...
          <Container style={{ marginTop: "8em", minWidth: "1260px" }}>
            <Header as="h3">
              <Header.Content
                style={{ paddingTop: 8, fontWeight: 400, fontSize: "14pt" }}
              >
                  ...
                  <Grid columns={2} centered>
                    <Grid.Column>
                      <svg width="500" height="30">
                        <text x={0} y={15} style={{ fontSize: "14pt" }}>
                          COVID-19 Outcome Measure:{" "}
                        </text>
                      </svg>
                      <Dropdown
                        style={{
                        ...
                        colorPalette && (
                          <svg width="450" height="110">
                            {_.map(legendSplitA, (split, i) => {
                              if (
                                legendSplitA[0].toFixed(0) ===
                                  legendSplitA[1].toFixed(0) &&
                                legendSplitA[1].toFixed(0) ===
                                  legendSplitA[2].toFixed(0) &&
                                legendSplitA[2].toFixed(0) ===
                                  legendSplitA[3].toFixed(0) &&
                                legendSplitA[3].toFixed(0) ===
                                  legendSplitA[4].toFixed(0)
                              ) {
                                return (
                                  <text
                                    key={i}
                                  ...
                                  >
                                    {" "}
                                    {legendSplitA[i].toFixed(2) < 0
                                      ? 0
                                      : legendSplitA[i].toFixed(2)}{" "}
                                  </text>
                                );
                                ...
                                return (
                                  ...
                                  >
                                    {" "}
                                    {legendSplitA[i].toFixed(1) < 0
                                      ? 0
                                      : legendSplitA[i].toFixed(1)}{" "}
                                  </text>
                                );
                                ...
                                return (
                                  ...
                                  >
                                    {" "}
                                    {(legendSplitA[i] / 1000).toFixed(0) < 0
                                      ? 0
                                      : (legendSplitA[i] / 1000).toFixed(0)}
                                    K{" "}
                                  </text>
                                );
                              }
                              return (
                                ...
                                >
                                  {" "}
                                  {legendSplitA[i].toFixed(0) < 0
                                    ? 0
                                    : legendSplitA[i].toFixed(0)}{" "}
                                </text>
                              );
                            })}
                            <text x={0} y={34} style={{ fontSize: "1.0em" }}>
                              {" "}
                              {legendMinA}{" "}
                            </text>
                            <text x={240} y={34} style={{ fontSize: "1.0em" }}>
                              {" "}
                              {legendMaxA}{" "}
                            </text>
                            ...
                            <text x={0} y={99} style={{ fontSize: "1.2em" }}>
                              {" "}
                              Low{" "}
                            </text>
                            <text
                              x={40 * (colorPalette.length - 1)}
                              y={99}
                            ...
                            />
                            <text x={330} y={56} style={{ fontSize: "1.2em" }}>
                              {" "}
                              None{" "}
                            </text>
                            <text x={330} y={76} style={{ fontSize: "1.2em" }}>
                              {" "}
                              Reported{" "}
                            </text>
                          </svg>
                ...
                <Grid.Column>
                  <Grid columns={2} centered>
                    <Grid.Column>
                      <svg width="500" height="30">
                        <text x={0} y={15} style={{ fontSize: "14pt" }}>
                          COVID-19 County Population Characteristics:{" "}
                        </text>
                      </svg>
                        ...
                        colorPalette2 && (
                          <svg width="450" height="110">
                            {_.map(legendSplitB, (split, i) => {
                              if (
                                legendSplitB[0].toFixed(0) ===
                                  legendSplitB[1].toFixed(0) &&
                                legendSplitB[1].toFixed(0) ===
                                  legendSplitB[2].toFixed(0) &&
                                legendSplitB[2].toFixed(0) ===
                                  legendSplitB[3].toFixed(0) &&
                                legendSplitB[3].toFixed(0) ===
                                  legendSplitB[4].toFixed(0)
                              ) {
                                return (
                                  <text
                                    key={i}
                                  ...
                                  >
                                    {" "}
                                    {legendSplitB[i].toFixed(2) < 0
                                      ? 0
                                      : legendSplitB[i].toFixed(2)}{" "}
                                  </text>
                                );
                                ...
                                return (
                                  ...
                                  >
                                    {" "}
                                    {legendSplitB[i].toFixed(1) < 0
                                      ? 0
                                      : legendSplitB[i].toFixed(1)}{" "}
                                  </text>
                                );
                                ...
                                return (
                                  ...
                                  >
                                    {" "}
                                    {(legendSplitB[i] / 1000).toFixed(0) < 0
                                      ? 0
                                      : (legendSplitB[i] / 1000000).toFixed(0)}
                                    M{" "}
                                  </text>
                                );
                              ...
                              return (
                                ...
                                >
                                  {" "}
                                  {legendSplitB[i].toFixed(0) < 0
                                    ? 0
                                    : legendSplitB[i].toFixed(0)}{" "}
                                </text>
                              );
                            })}
                            <text x={0} y={34} style={{ fontSize: "1.0em" }}>
                      ...
                      {measureB === "Urban-Rural" &&
                        ...
                        colorPalette2 && (
                          <svg width="450" height="220">
                            <text x={95} y={40} style={{ fontSize: "1em" }}>
                              {" "}
                              Remote rural area
                            </text>
                            <text x={95} y={70} style={{ fontSize: "1em" }}>
                              {" "}
                              Rural areas near cities
                            </text>
                            <text x={95} y={100} style={{ fontSize: "1em" }}>
                              {" "}
                              Small cities
                            </text>
                            <text x={95} y={130} style={{ fontSize: "1em" }}>
                              {" "}
                              Small suburbs
                            </text>
                            <text x={95} y={160} style={{ fontSize: "1em" }}>
                              {" "}
                              Large suburbs
                            </text>
                            <text x={95} y={190} style={{ fontSize: "1em" }}>
                              {" "}
                              Inner City
                            </text>
                            ...
                            />
                            <text x={290} y={33} style={{ fontSize: "1em" }}>
                              {" "}
                              None{" "}
                            </text>
                            <text x={290} y={48} style={{ fontSize: "1em" }}>
                              {" "}
                              Reported{" "}
                            </text>
                          </svg>
                          ...
                          <Geography
                            ...
                            onMouseEnter={() => {
                              if (measureA && colorScaleA) {
                                const cur =
                                  data[measureA][geo.properties.COUNTYFP];
                                setTooltipContent(
                            ...
                            fill={
                              ...
                              colorScaleA &&
                              stateFips === "_nation" &&
                              data[measureA][geo.id] > 0
                                ? colorScaleA[data[measureA][geo.id]]
                                : measureA &&
                                  colorScaleA &&
                                  stateFips === "_nation" &&
                                  data[measureA][geo.id] === 0
                          ...
                          <Geography
                            ...
                            onMouseEnter={() => {
                              if (measureB && colorScaleB) {
                                const cur =
                                  data[measureB][geo.properties.COUNTYFP];
                                setTooltipContent(
                                  cur ? Math.round(cur * 100) / 100 : ""
                                );
                              }
                            ...
                            fill={
                              ...
                              colorScaleB &&
                              stateFips === "_nation" &&
                              data[measureB][geo.id] > 0
                                ? colorScaleB[data[measureB][geo.id]]
                                : measureB &&
                                  colorScaleB &&
                                  stateFips === "_nation" &&
                                  data[measureB][geo.id] === 0
