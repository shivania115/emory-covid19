...
export default function DataSources(props){
  ...
  return (
    <div>
      ...
      <Grid columns={3} style={{paddingLeft: 0, paddingTop: 2}}>
        <Grid.Row columns={3} style={{width: 400, paddingBottom: 20}}> 
          ...
          <Grid.Column rows = {2} style={{width: 420, paddingBottom: 20, paddingTop: 0}}>
            ...
            <div style = {{paddingLeft: 0}}>
              <Header as='h2' style={{width:400, paddingTop:0}}>
          ...
          <Grid.Column rows = {2} style={{width: 400, paddingBottom: 20, paddingTop: 0}}>
            <div style = {{paddingLeft: 2.5, paddingBottom: 10}}>
          ...
          <Grid.Column rows = {2} style={{width: 400, paddingBottom: 20}}>
          ...
          <Grid.Column rows = {2} style={{width: 400, paddingBottom: 20, paddingTop:70}}>
            <div style = {{paddingLeft: 0, paddingBottom: 10}}>
