...
function BarChart(props) {
  if (props.stateFips !== "_nation") {
    return (
      ...
      >
        {props.title !== "Community Vulnerability Index" &&
          props.title !== "Any Condition" && (
            <VictoryLabel
              text={props.title}
              x={200}
              y={10}
        ...
        <VictoryBar
          ...
          labelComponent={
            <VictoryLabel
              dx={5}
              style={{ fontFamily: "lato", fontSize: "14px", fill: "#000000" }}
            />
          }
          style={{
            data: {
...
function TopChart(params) {
  return (
    <VictoryChart
      minDomain={{
        x:
          params.sFips !== "_nation"
            ? params.data[params.data.length - params.recentIndex - 15][
                params.xVar
              ]
            : 0,
      }}
      maxDomain={{
        x:
          params.sFips !== "_nation"
            ? params.data[params.data.length - params.recentIndex - 1][
                params.xVar
              ]
            : 0,
        y:
          params.sFips !== "_nation"
            ? getMaxRange(
                params.data,
                params.yVar,
                params.data.length - params.recentIndex - 15
              ) * params.resize
            : 0,
      }}
      width={235}
    ...
    >
      <VictoryAxis
        tickValues={
          params.sFips !== "_nation"
            ? [
                params.data[
                  params.data.length -
                    Math.round(params.data.length / 3) * 2 -
                    1
                ][params.xVar],
                params.data[
                  params.data.length - Math.round(params.data.length / 3) - 1
                ][params.xVar],
                params.data[params.data.length - params.recentIndex - 1][
                  params.xVar
                ],
        ...
        style={{
          ...
          tickLabels: { background: "#ccdee8", fontSize: 10 },
        }}
      ...
      <VictoryGroup colorScale={[stateColor]}>
        <VictoryLine
          data={
            params.data && params.sFips !== "_nation" ? params.data : [0, 0, 0]
          }
          x={params.xVar}
          y={params.yVar}
        />
      ...
      <VictoryLabel
        text={params.sFips === "_nation" ? 0 : params.rate}
        x={115}
        y={60}
        textAnchor="middle"
        style={{ fontSize: 50, fontFamily: "lato" }}
      />
      <VictoryLabel
        text={params.sFips === "_nation" ? "" : params.percentChange}
        x={115}
        y={115}
        textAnchor="middle"
        style={{ fontSize: 24, fontFamily: "lato" }}
      />
      <VictoryLabel
        text={params.sFips === "_nation" ? "" : "14-day"}
        x={180}
        y={110}
        textAnchor="middle"
      ...
      />
      <VictoryLabel
        text={params.sFips === "_nation" ? "" : "change"}
        x={180}
        y={120}
        textAnchor="middle"
        style={{ fontSize: 12, fontFamily: "lato" }}
...
export default function StateMap(props) {
        ...
        if (isLoggedIn === true) {
          ...
          const fetchData = async () => {
            if (stateFips !== "_nation") {
              ...
              const promState = await CHED_series.find(stateSeriesQ, {
                projection: {},
              }).toArray();
              ...
              if (stateFips === "_nation") {
                ...
                //case rate
                caseRate =
                  stateSeriesDict[stateSeriesDict.length - 1].dailyCases;
                percentChangeCase =
                  stateSeriesDict[stateSeriesDict.length - 1]
                    .percent14dayDailyCases;

                //mortality rate
                mortality =
                  stateSeriesDict[stateSeriesDict.length - 1].dailyMortality;
                ...
                if (
                  stateSeriesDict[stateSeriesDict.length - 1].hospDaily === 0
                ) {
                  for (var i = stateSeriesDict.length - 1; i >= 0; i--) {
                    if (i === 0) {
                      indexP = 1;
                      hospD =
                        stateSeriesDict[stateSeriesDict.length - 1].hospDaily;
                      percentChangeHospDaily =
                        stateSeriesDict[stateSeriesDict.length - 1]
                          .percent14dayhospDaily;
                    } else if (stateSeriesDict[i].hospDaily === 0) {
                    } else {
                      indexP = stateSeriesDict.length - i;
                      hospD = stateSeriesDict[i].hospDaily;
                      percentChangeHospDaily =
                        stateSeriesDict[i].percent14dayhospDaily;
            ...
            setHospDate(
              "0" +
                new Date(hospDate * 1000).toLocaleDateString().substring(0, 2) +
                "0" +
                new Date(hospDate * 1000).toLocaleDateString().substring(2)
            );
            //manipulate string
            if (percentChangeCase.toFixed(0) > 0) {
              setPercentChangeCases("+" + percentChangeCase.toFixed(0) + "%");
            } else if (percentChangeCase.toFixed(0).substring(1) === "0") {
              setPercentChangeCases(
                percentChangeCase.toFixed(0).substring(1) + "%"
              );
            } else {
              setPercentChangeCases(percentChangeCase.toFixed(0) + "%");
            }
            ...
            if (percentChangeMortality.toFixed(0) > 0) {
              setPercentChangeMortality(
                "+" + percentChangeMortality.toFixed(0) + "%"
              );
            } else if (percentChangeMortality.toFixed(0).substring(1) === "0") {
              setPercentChangeMortality(
                percentChangeMortality.toFixed(0).substring(1) + "%"
              );
            } else {
              setPercentChangeMortality(
                percentChangeMortality.toFixed(0) + "%"
            ...
            if (percentChangeHospDaily.toFixed(0) > 0) {
              setPercentChangeHospDaily(
                "+" + percentChangeHospDaily.toFixed(0) + "%"
              );
            } else if (percentChangeHospDaily.toFixed(0).substring(1) === "0") {
              setPercentChangeHospDaily(
                percentChangeHospDaily.toFixed(0).substring(1) + "%"
              );
            } else {
              setPercentChangeHospDaily(
                percentChangeHospDaily.toFixed(0) + "%"
            ...
            if (stateFips !== "_nation") {
              ...
              _.each(seriesDict, (v, k) => {
                if (
                  k.length === 5 &&
                  v.length > 0 &&
                  v[v.length - 1].covidmortality7dayfig > covidmortality7dayfig
                ) {
                  countyMost = k.substring(2, 5);
                  covidmortality7dayfig = v[v.length - 1].covidmortality7dayfig;
                }
            ...
            if (stateFips !== "_nation") {
              setCountyName(fips2county[stateFips + countyMost]);
              setBarCountyName(
                fips2county[stateFips + countyMost].match(/\S+/)[0]
              );
            }
  ...
  useEffect(() => {
    if (stateFips !== "_nation") {
      ...
      const cs = scaleQuantile()
        .domain(
          _.map(
            _.filter(data, (d) => d[metric] > 0 && d.fips.length === 5),
            (d) => d[metric]
          )
        )
        .range(colorPalette);
  ...
  if (
    stateFips === "_nation" ||
    (data && metric && trendOptions && trendline)
  ) {
        ...
        <div>
              ...
              <div>
                  ...
                  <div style={{ paddingTop: 26, paddingBottom: 6 }}>
                    ...
                    >
                      <p style={{ fontSize: "20pt" }}>
                        Select your state and then select your county.
                      </p>
                        ...
                        <div style={{ width: 235, background: "#e5f2f7" }}>
                          ...
                          {stateFips && dataStateTS && stateFips !== "_nation" && (
                            ...
                            >
                                ...
                                tickValues={
                                  stateFips !== "_nation"
                                    ? [
                                        dataStateTS[
                                          dataStateTS.length -
                                            Math.round(dataStateTS.length / 3) *
                                              2 -
                                            1
                                        ].t,
                                        dataStateTS[
                              ...
                              <VictoryArea
                                style={{
                                  data: { fill: "#080808", fillOpacity: 0.1 },
                                }}
                                data={
                                  dataStateTS && stateFips !== "_nation"
                                    ? dataStateTS
                              ...
                              />
                              <VictoryLabel
                                text={stateFips === "_nation" ? 0 : pctPositive}
                                x={115}
                                y={60}
                                textAnchor="middle"
                                style={{ fontSize: 50, fontFamily: "lato" }}
                                  ...
                                  >
                                    ...
                                    <VictoryGroup>
                                      {"Asian Alone" in raceData[stateFips] &&
                                        raceData[stateFips]["Asian Alone"][0][
                                          "deathrateRace"
                                        ] >= 0 &&
                                        raceData[stateFips]["Asian Alone"][0][
                                          "deaths"
                                        ...
                                        raceData[stateFips]["Asian Alone"][0][
                                          ...
                                          <VictoryBar
                                            ...
                                            labels={({ datum }) =>
                                              numberWithCommas(
                                                parseFloat(datum.value).toFixed(
                                                  0
                                                )
                                              )
                                            }
                                      ...
                                      {"White Alone" in raceData[stateFips] &&
                                        raceData[stateFips]["White Alone"][0][
                                          "deathrateRace"
                                        ] >= 0 &&
                                        raceData[stateFips]["White Alone"][0][
                                          "deaths"
                            ...
                            <Grid.Row>
                              {stateFips !== "_nation" &&
                                ...
                                !(
                                  ...
                                  !(
                                    (!raceData[stateFips]["Hispanic"] ||
                                      raceData[stateFips]["Hispanic"][0][
                                        "deathrateEthnicity"
                                      ] < 0) &&
                                    (!raceData[stateFips]["Non Hispanic"] ||
                                      raceData[stateFips]["Non Hispanic"][0][
                                        "deathrateEthnicity"
                                      ] < 0) &&
                                    !raceData[stateFips][
                                      "Non-Hispanic African American"
                                    ...
                                    !raceData[stateFips]["Non-Hispanic White"]
                                  )
                                ) && (
                              ...
                              {stateFips !== "38" &&
                                ...
                                !(
                                  ...
                                  !raceData[stateFips]["Non-Hispanic Asian"] &&
                                  !raceData[stateFips]["Non-Hispanic White"]
                                ) && (
                                  <VictoryChart
                                    theme={VictoryTheme.material}
                    ...
                    >
                      ...
                      >
                        <Header.Content
                          style={{ fontWeight: 300, fontSize: "14pt" }}
                        >
                          Daily new COVID-19 Hospitalization <br />
                          <br />
                          <br />
                          <i>Data source</i>:
                          <a
                      ...
                      >
                        <Header.Content
                          style={{ fontWeight: 300, fontSize: "14pt" }}
                        >
                          Percentage of total tests for COVID-19 that resulted
                                ...
                                {stateFips !== "_nation" && stateFips === "38" && (
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <br />
                                      Hospitalization data last updated:{" "}
                                      {hospDate}.
                                      <br />
                                      {stateName} is not reporting deaths by
                                      race or ethnicity.
                                      <br />
                                      Race data last updated:{" "}
                                      {racedatadate.date.substring(5, 7) +
                                        "/" +
                                        racedatadate.date.substring(8, 10) +
                                        "/" +
                                        racedatadate.date.substring(0, 4)}
                                      .
                                    </text>
                                  </Grid.Row>
                                )}
                                ...
                                {stateFips !== "_nation" && stateFips !== "38" && (
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      {hospDate}.
                                      <br />
                                      {stateName} reports distribution of deaths
                                      across non-Hispanic race categories, with{" "}
                                      {!!raceData[stateFips]["Race Missing"]
                                        ? raceData[stateFips][
                                            "Race Missing"
                                          ][0]["percentRaceDeaths"] + "%"
                                        : !!raceData[stateFips][
                                        ...
                                        ? raceData[stateFips][
                                            "Ethnicity Missing"
                                          ][0]["percentEthnicityDeaths"] + "%"
                                        : !!raceData[stateFips][
                                            "Race & Ethnicity Missing"
                                          ]
                                        ? raceData[stateFips][
                                            "Race & Ethnicity Missing"
                                          ][0]["percentRaceEthnicityDeaths"] +
                                          "%"
                                        : "na%"}{" "}
                                      of deaths of known{" "}
                                      {!!raceData[stateFips]["Race Missing"]
                                        ...
                                        ? "race & ethnicity"
                                        : "race & ethnicity"}
                                      . Here we only show race categories that
                                      constitute at least 1% of the state
                                      population and have 30 or more deaths.
                                      <br />
                                      Race data last updated:{" "}
                                      {racedatadate.date.substring(5, 7) +
                                        "/" +
                  ...
                  <Grid.Row style={{ width: 1260 }}>
                    <Grid.Column style={{ width: 450 }}>
                      <Dropdown
                        ...
                        text={
                          stateFips !== "_nation" ? metricName : "Select Metric"
                        }
                        search
                        selection
                        pointing="top"
                      ...
                      <Dropdown
                        ...
                        text={
                          countyName !== ""
                            ? countyName
                            : "Select County/Census Area/Borough"
                        }
                        search
                        selection
                        pointing="top"
                        ...
                        onChange={(e, { value }) => {
                          ...
                          setBarCountyName(
                            fips2county[stateFips + value].match(/\S+/)[0]
                          );
                        }}
                      />
                      {dataTS && legendSplit && (
                        <svg width="420" height="90">
                          ...
                          <text x={0} y={35} style={{ fontSize: "0.7em" }}>
                            {" "}
                            {legendMin}{" "}
                          </text>
                          <text x={120} y={35} style={{ fontSize: "0.7em" }}>
                            {legendMax}
                          </text>
                          ...
                          <text x={0} y={74} style={{ fontSize: "0.8em" }}>
                            Low
                          </text>
                          <text
                            x={20 * (colorPalette.length - 1)}
                            y={74}
                          ...
                          />
                          <text x={167} y={50} style={{ fontSize: "0.7em" }}>
                            {" "}
                            None{" "}
                          </text>
                          <text x={167} y={59} style={{ fontSize: "0.7em" }}>
                            {" "}
                            Reported{" "}
                          </text>

                          <text x={250} y={49} style={{ fontSize: "1em" }}>
                            {" "}
                            Click on a county
                          </text>
                          <text x={250} y={65} style={{ fontSize: "1em" }}>
                            {" "}
                                      ...
                                      {stateFips !== "_nation" && (
                                        <Grid.Row style={{ width: "420px" }}>
                                          ...
                                          >
                                            ...
                                            For a complete table of variable
                                            definition, click{" "}
                                            <a
                                              style={{ color: "#397AB9" }}
                    ...
                    >
                      ...
                      {true && (
                        <Grid>
                          <Header
                            as="h2"
                            style={{ fontWeight: 400, width: 800 }}
                          >
                            <Header.Content style={{ fontSize: "22px" }}>
                              <b>
                                {stateFips === "_nation" || stateFips === "72"
                                  ...
                                  : countyName
                                  ? "Vaccination Status in  " + countyName
                                  : "Loading..."}
                              </b>
                              <Header.Subheader
                                style={{
                                    ...
                                    content: {
                                      content: (
                                        ...
                                        >
                                          ...
                                          , last updated on {vaccineDate} <br />
                                          <b>
                                            <em>
                                              {" "}
                                              {
                                                vaxVarMap["Doses_Distributed"]
                                                  .name
                                              }{" "}
                                            </em>
                                          </b>{" "}
                      ...
                      <Header as="h2" style={{ fontWeight: 400, width: 800 }}>
                        <Header.Content style={{ fontSize: "22px" }}>
                          ...
                          >
                            The number of cases and deaths due to COVID-19 are
                            dynamic. Cases are declining in many counties and
                            rising in others. Trends in the case and death count
                            in the past 14 days are being monitored to determine
                            whether it is safe to reopen a county.
                            <br />
                            <br />
                            ...
                            <Grid.Column>
                              ...
                              <Dropdown
                                ...
                                text={
                                  selectedTrend
                                    ? selectedTrend
                                    : "Average Daily COVID-19 Cases/100,000"
                                }
                                pointing="top"
                                search
                                selection
                ...
                <Header as="h2" style={{ paddingBottom: 10, paddingTop: 10 }}>
                  <Header.Content style={{ fontSize: "22px", marginTop: 6 }}>
                    ...
                    >
                      Social, economic, health and environmental factors impact
                      an individual’s risk of infection and COVID-19 severity.
                ...
                {!countyFips && <div style={{ height: 300 }}></div>}
                {countyFips && (
                  <div>
                    <Grid>
                      <Grid.Row>
                      ...
                      >
                        ...
                        >
                          *The state and national level measure of any chronic
                          condition prevalence (per 100,000) is computed with
                          the average of all the counties and states.
                          <br />
                          *The national level measures of COVID-19 Community
                          Vulnerability Index and Residential Segregation Index
                          are computed with the average of all the states.
                        </text>
                      </Grid.Row>
                    </Grid>
                  </div>
          ...
          {stateFips !== "_nation" && (
            <ReactTooltip>
              ...
              <br /> Click for a detailed report.{" "}
            </ReactTooltip>
          )}
        </div>
      </HEProvider>
