  ...
  return (
    <div>
      ...
      <Grid>
        ...
        <Header block as='h2' style={{fontWeight: 600, paddingLeft: '1rem'}}>
            General Information
        </Header>
        <div><br/></div>
        ...
        <Header as='h3' style={{fontSize:'16pt', paddingTop: '0rem', paddingLeft:'2rem'}}>
        ...
        <Header as='h3' style={{fontSize:'16pt', paddingTop: '1rem',  paddingLeft:'2rem'}}>
        ...
        <Container style={{paddingLeft:'6rem', paddingBottom:'0.5rem'}}>
        ...
        <p style={{paddingTop:'1rem', paddingLeft:'4rem', paddingRight:'1rem', marginBottom:'0', fontWeight: 400, fontSize: "14pt", textAlign: 'justify'}}>
        ...
        <p style={{paddingTop:'0rem', paddingLeft:'4rem', paddingRight:'1rem', marginBottom:'0', fontWeight: 400, fontSize: "14pt", textAlign: 'justify'}}>
        ...
        <p style={{fontSize:'14pt', paddingLeft:'4rem'}}>
