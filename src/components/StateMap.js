  ...
  if (props.stateFips !== "_nation") {
    return (
      <VictoryChart
        ...
        containerComponent={
          <VictoryContainer renderInPortal={true} responsive={false} />
        }
      >
    ...
    return (
      <VictoryChart
        ...
        containerComponent={
          <VictoryContainer renderInPortal={false} responsive={false} />
        }
      >
        <VictoryLabel
          text={props.title}
      ...
      if (!configMatched) {
        ...
        if (isLoggedIn === true) {
          ...
          const fetchData = async () => {
            if (stateFips !== "_nation") {
              ...
              if (stateFips === "_nation") {
                ...
                if (
                  ...
                  for (var i = stateSeriesDict.length - 1; i >= 0; i--) {
                    if (i === 0) {
                      ...
                      percentChangeHospDaily =
                        stateSeriesDict[i].percent7dayhospDaily;
                ...
                if (
                  ...
                  percentPositive =
                    stateSeriesDict[stateSeriesDict.length - 1].percentPositive;
                }
              }
            }
            ...
            setHospDate(
              "" +
                (new Date(hospDate * 1000).getMonth() + 1)
                  .toString()
                  .padStart(2, "0") +
                "/" +
                new Date(hospDate * 1000)
                  .getDate()
                  .toString()
                  .padStart(2, "0") +
                "/" +
                new Date(hospDate * 1000).getFullYear().toString()
            );
            //manipulate string
            if (percentChangeCase.toFixed(0) > 0) {
              setPercentChangeCases("+" + percentChangeCase.toFixed(0) + "%");
                  ...
                  <Grid.Row style={{ width: 1260 }}>
                    ...
                    >
                      ...
                      <Header as="h2" style={{ width: 800, paddingBottom: 10 }}>
                        <Header.Content
                          style={{ fontSize: "22px", marginTop: 6 }}
                        >
                          {stateFips === "_nation" || stateFips === "72"
                            ? ""
                            : countyName}{" "}
                          ...
                          >
                            ...
                            impact an individual’s risk of infection and
                            COVID-19 severity. Counties with large groups of
                            vulnerable people may be disproportionately impacted
                            by COVID-19.
                          </Header.Subheader>
                        </Header.Content>
                      </Header>
                        ...
                        >
                          ...
                          >
                            *The state and national level measure of any chronic
                            condition prevalence (per 100K) is computed with the
                            average of all the counties and states.
                            <br />
                            *The national level measure of COVID-19 Community
                            Vulnerability Index is computed with the average of
                            all the states.
                          </text>
                        </Grid.Row>
                      </Grid>
