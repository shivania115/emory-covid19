...
export default function USMapPilot(props) {
  const {
    isLoggedIn,
        ...
        <Grid>
          ...
          <Grid.Row style={{ paddingTop: 22, paddingBottom: 53 }}>
            ...
            >
              ...
              ethnicity data are known for 95% of deaths in the nation. NHPI:
          ...
          <Grid.Row style={{ paddingTop: 22, paddingBottom: 53 }}>
            ...
            >
              ...
              {stateName == "The United States"
                ? "the United States"
                : stateName}{" "}
              is shown on the right. NHPI: Native Hawaiians and Pacific
              Islanders.
              <br />
              <br /> <i>Data source</i>:{" "}
              <a
              ...
              <Grid.Row style={{ width: "100%", height: "100%" }}>
                ...
                >
                  ...
                  >
                    ...
                    <a
                      style={{ color: "#397AB9" }}
                      href="https://youtu.be/PmI42rHnI6U"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      {" "}
